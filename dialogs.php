...
echo "<div class='symposium_sending' style='display:none; z-index:999999;'><img src='".WPS_IMAGES_URL."/busy.gif' /> ".__('Sending...', 'wp-symposium')."</div>";	
...
echo "<div id='symposium_attention' style='display:none'>".WPS_POKE_LABEL."</div>";
