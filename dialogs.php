...
echo "<div id='symposium_clear' style='display:none'>".__("Clear", "wp-symposium")."</div>";
...
echo "<div id='symposium_likes' style='display:none'>".__("Likes", "wp-symposium")."</div>";
echo "<div id='symposium_dislikes' style='display:none'>".__("Dislikes", "wp-symposium")."</div>";
...
echo "<div id='symposium_gallery_labels' style='display:none'>".__("Rename|Photo renamed.|Drag thumbnails to re-order, and then|save|Delete this photo|Set as album cover", "wp-symposium")."</div>";
