...
class __wps__summary_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<br /><br />
			...
			<input id="<?php echo $this->get_field_id( 'show_avatar_size' ); ?>" style="width: 30px" name="<?php echo $this->get_field_name( 'show_avatar_size' ); ?>" value="<?php echo $show_avatar_size; ?>" /><br />
		<br />
