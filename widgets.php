...
class __wps__friends_status_Widget extends WP_Widget {
	...
	function __wps__friends_status_Widget() {
		...
		parent::__construct( 
		    ...
		    WPS_WL_SHORT.': '.sprintf(__('%s Status', WPS_TEXT_DOMAIN), get_option(WPS_OPTIONS_PREFIX.'_alt_friends')),
		    $widget_ops, 
		    $control_ops 
		);
	}
...
class __wps__recent_Widget extends WP_Widget {
	...
	function __wps__recent_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 
		    'symposium_recent-widget', 
		    WPS_WL_SHORT.': '.__('Recently Online', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
...
class __wps__recentactivity_Widget extends WP_Widget {
	...
	function __wps__recentactivity_Widget() {
		...
		parent::__construct( 
		    ...
		    WPS_WL_SHORT.': '.__('Recent Activity', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
	}
...
class __wps__members_Widget extends WP_Widget {
	...
	function __wps__members_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 
		    'symposium_members-widget', 
		    WPS_WL_SHORT.': '.__('Latest New Members', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
...
class __wps__friends_Widget extends WP_Widget {
	...
	function __wps__friends_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 
		    'symposium_friends-widget', 
			WPS_WL_SHORT.': '.sprintf(__('Your %s', WPS_TEXT_DOMAIN), get_option(WPS_OPTIONS_PREFIX.'_alt_friends')),
		    $widget_ops, 
		    $control_ops 
		);
...
class __wps__forumrecentposts_Widget extends WP_Widget {
	...
	function __wps__forumrecentposts_Widget() {
		...
		parent::__construct( 
		    ...
		    WPS_WL_SHORT.': '.__('Latest Forum Posts', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
...
class __wps__summary_Widget extends WP_Widget {
	...
	function __wps__summary_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 
		    'symposium_summary-widget', 
			WPS_WL_SHORT.': '.__('Summary', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
	}
...
class __wps__forumnoanswer_Widget extends WP_Widget {
	...
	function __wps__forumnoanswer_Widget() {
		...
		parent::__construct( 
		    ...
		    WPS_WL_SHORT.': '.__('Topics without an accepted answer', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
	}
...
class __wps__forumexperts_Widget extends WP_Widget {
	...
	function __wps__forumexperts_Widget() {
		...
		parent::__construct( 
		    'forumexperts-widget', 
		    WPS_WL_SHORT.': '.__('Top Experts', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
	}
...
class __wps__alerts_Widget extends WP_Widget {
	...
	function __wps__alerts_Widget() {
		...
		parent::__construct( 
		    'alerts-widget', 
			WPS_WL_SHORT.': '.__('Recent Alerts', WPS_TEXT_DOMAIN),
		    $widget_ops, 
		    $control_ops 
		);
	}
