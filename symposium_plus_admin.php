...
symposium_show_tabs_header('plus');
...
?>
	...
	<span class="description"><?php echo sprintf(__('Include %s Photo albums in search results', 'wp-symposium'), WPS_WL); ?></span></td> 
	</tr> 
	...
	<span class="description"><?php echo sprintf(__('Include %s Groups in search results', 'wp-symposium'), WPS_WL); ?></span></td> 
	</tr> 
	...
	<span class="description"><?php echo sprintf(__('Include %s Forum topics in search results', 'wp-symposium'), WPS_WL); ?></span></td> 
	</tr> 
