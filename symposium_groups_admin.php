...
symposium_show_tabs_header('groups');
?>
...
<?php
	...
	<table class="form-table"> 
		...
		<span class="description"><?php echo __('Comma separated list of group ID\'s that new members are assigned to (leave blank for none)', 'wp-symposium'); ?></td> 
		</tr> 
	...
	echo '<h3>'.__('Delete group / manage group members', 'wp-symposium').'</h3>';
	...
	if ($groups) {
		...
		echo '<option value=0>'.__('-- Select a group --', 'wp-symposium').'</option>';
		...
		echo '<a href="javascript:void(0)" id="group_list_delete_link">'.__('Delete this group', 'wp-symposium').'</a>';
		echo '</div>';
