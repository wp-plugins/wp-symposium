...
function symposium_forum_latestposts_showThreadChildren($count, $parent, $level, $use_answers) {
	...
	if ($count != '') { 
		...
		$postcount = WPS_SYMPOSIUM_FORUMLATESTPOSTS_COUNT;
	}
	...
	$posts = $wpdb->get_results("
		SELECT tid, topic_subject, topic_owner, topic_post, topic_category, topic_started, display_name, topic_parent, topic_answer, topic_date, topic_approved 
