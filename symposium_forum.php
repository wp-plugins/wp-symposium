...
function symposium_forum_latestposts() {
	...
	$html .= symposium_forum_latestposts_showThreadChildren(0, 0);	
	$html .= '</div>';

	return $html;

}
function symposium_forum_latestposts_showThreadChildren($parent, $level) {
	...
	if ($posts) {
		...
		foreach ($posts as $post)
		{
			...
			$html .= symposium_forum_latestposts_showThreadChildren($post->tid, $level+1);
