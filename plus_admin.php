...
?>
	...
	<ol>
	<span class="description"><li><?php echo __('Reset to the horizontal <a href="admin.php?page=symposium_templates">Profile Page Body</a> template.', WPS_TEXT_DOMAIN); ?></span><br />
	<span class="description"><li><?php echo __('Set up your menu on the <a href="admin.php?page=symposium_profile">profile options page</a>.', WPS_TEXT_DOMAIN); ?></li></span>
	<?php if (function_exists('__wps__group')) { ?>
		<span class="description"><li><?php echo __('Reset to the horizontal <a href="admin.php?page=symposium_templates">Group Page</a> template.', WPS_TEXT_DOMAIN); ?></span><br />
		<span class="description"><li><?php echo __('Set up your group menu on the <a href="admin.php?page=wp-symposium/groups_admin.php">groups options page</a>.', WPS_TEXT_DOMAIN); ?></li></span>
	<?php } ?>
	</ol>
	</td> 
	</tr> 
