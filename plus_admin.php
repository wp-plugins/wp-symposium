...
__wps__show_tabs_header('plus');
	...
	if( isset($_POST[ '__wps__profile_plus_updated' ]) ) {
		...
		update_option(WPS_OPTIONS_PREFIX.'_activity_images_old', $activity_images_old);
		update_option(WPS_OPTIONS_PREFIX.'_activity_likes', $activity_likes);
		...
		update_option(WPS_OPTIONS_PREFIX."_profile_menu_adjust", $profile_menu_adjust);
	...
	if (get_option(WPS_OPTIONS_PREFIX."_profile_menu_adjust") == '') update_option(WPS_OPTIONS_PREFIX."_profile_menu_adjust", '0');
...
?>
	...
	<tr valign="top"> 
	<td scope="row" style="text-align:right"><label for="profile_menu_delta"><?php echo __('Fixed position', WPS_TEXT_DOMAIN); ?></label></td> 
	...
	<span class="description"><?php echo __('The space above the fixed menu when the page is scrolling down (pixels)', WPS_TEXT_DOMAIN); ?></td> 
	</tr> 

	<tr valign="top"> 
	<td scope="row" style="text-align:right"><label for="profile_menu_adjust"><?php echo __('Adjustment', WPS_TEXT_DOMAIN); ?></label></td> 
	<td><input name="profile_menu_adjust" type="text" id="profile_menu_adjust" style="width:50px" value="<?php echo get_option(WPS_OPTIONS_PREFIX.'_profile_menu_adjust'); ?>" /> 
	<span class="description"><?php echo __('Additional space at top of menu before and when moving (pixels)', WPS_TEXT_DOMAIN); ?></td> 
	</tr> 
	...
	<span class="description"><?php echo __('Allow users with modern browsers that support HTML5 (not IE, humph) to attach images to profile posts (<strong></strong>BETA</strong>)', WPS_TEXT_DOMAIN); ?></span><br />
	<input type="checkbox" name="activity_images_old" id="activity_images_old" <?php if ($activity_images_old == "on") { echo "CHECKED"; } ?>/>
	<span class="description"><?php echo __('Show prompt to upgrade browsers, for those who are not using modern browsers (and Microsoft IE)', WPS_TEXT_DOMAIN); ?></span>
	</td> 
	</tr> 
	...
	<span class="description"><?php echo __('Enables the hover box when cursor moved over profile avatar', WPS_TEXT_DOMAIN); ?></span></td> 
	</tr> 
	...
	<span class="description">
		<?php echo sprintf(__('Use [%s-search] shortcode, or put &quot;echo %ssearch(150)&quot; in PHP, where 150 is the width in pixels.', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX, '__wps__'); ?><br />
	...
	<tr><td colspan="2"><h2><?php _e('Profile page menu', WPS_TEXT_DOMAIN) ?></h2></td></tr>
	
	<tr valign="top"> 
	<td scope="row" style="text-align:right"><label for="wps_profile_menu_type"><?php echo __('Activate menu/tab version', WPS_TEXT_DOMAIN); ?> (BETA)</label></td>
	<td>
	...
	<span class="description"><?php echo __('Check to select horizontal menu/tab version', WPS_TEXT_DOMAIN); ?></span><br />
	<span class="description"><strong><?php echo __('Important!', WPS_TEXT_DOMAIN); ?></strong></span><br />
	<span class="description"><?php echo __('1. Reset to the correct <a href="admin.php?page=symposium_templates">Profile Page Body</a> template.', WPS_TEXT_DOMAIN); ?></span><br />
	<span class="description"><?php echo __('2. Set up your menu on the <a href="admin.php?page=symposium_profile">profile options page</a>.', WPS_TEXT_DOMAIN); ?></span>
	</td> 
	</tr> 
