...
if (is_user_logged_in()) {
	...
	echo '<div id="__wps__file_upload_basic">';
		
		if (isset($_POST['uploader_uid']) && isset($_FILES["file"]["name"])) {
			...
			echo '<div id="__wps__file_upload_basic_form">';
			echo '<form action="file_upload_form.php" method="post" enctype="multipart/form-data">';
