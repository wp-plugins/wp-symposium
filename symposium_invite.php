...
if (is_user_logged_in()) {
	...
	<div class="login" style="width:400px; margin: 80px auto;">
		...
		<form name="loginform" id="loginform" action="<?php echo site_url('wp-login.php', 'login_post') ?>" method="post">
			<p><?php _e('To continue, please log in or register.', 'wp-symposium'); ?></p>
			<p> 
				<label><?php _e('Username', 'wp-symposium') ?><br /> 
			...
			<p class="forgetmenot"><label><input name="rememberme" type="checkbox" id="rememberme" value="forever" tabindex="90" /> <?php esc_attr_e('Remember Me', 'wp-symposium'); ?></label></p> 
			<p class="submit"> 
				<input type="submit" name="wp-submit" id="wp-submit" class="button-primary" value="<?php esc_attr_e('Log In', 'wp-symposium'); ?>" tabindex="100" />
		...
		<a href="<?php echo site_url('wp-login.php?action=register', 'login') ?>"><?php _e('Register', 'wp-symposium') ?></a> |
		<a href="<?php echo site_url('wp-login.php?action=lostpassword', 'login') ?>" title="<?php _e('Password Lost and Found', 'wp-symposium') ?>"><?php _e('Lost your password?', 'wp-symposium') ?></a>
		<?php else : ?>
		<a href="<?php echo site_url('wp-login.php?action=lostpassword', 'login') ?>" title="<?php _e('Password Lost and Found', 'wp-symposium') ?>"><?php _e('Lost your password?', 'wp-symposium') ?></a>
		<?php endif; ?>
		</p>
