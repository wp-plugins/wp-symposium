...
function __wps__addChatWindow($id) {
	...
	echo "<div id='chat".$id."' title='chat".$id."' class='__wps__chat_window' style='clear:none; display:none;'>";
		...
		echo "</div>";
		echo "<div class='__wps__chat_message_div'><textarea id='chat".$id."_textarea' class='__wps__chat_message' onclick='if (this.value == \"".__("Type here...", WPS_TEXT_DOMAIN)."\") { this.value=\"\"; }'>".__("Type here...", WPS_TEXT_DOMAIN)."</textarea>";
		echo "</div>";
	echo "</div>";
