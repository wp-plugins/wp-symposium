...
echo '<div class="subheading">'.__('Add a topic', 'wp-symposium').'</div>';
...
if ( is_user_logged_in() ) {
	...
	echo '<div class="form">';
		...
		echo __('New topic subject', 'wp-symposium').'<br />';
		echo '<input type="text" class="input" name="new_topic_subject" /><br />';
		echo __('New topic text', 'wp-symposium').'<br />';
		echo '<textarea name="new_topic_post"></textarea><br />';
		echo '<input type="submit" class="submit" value="'.__('Start topic in', 'wp-symposium').' '.$cat_name.'" />';
		echo '</form>';
	echo '</div>';
