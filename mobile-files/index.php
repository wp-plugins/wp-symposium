...
if ( !is_user_logged_in() ) {
	echo '<div class="line"><a href="login.php?'.$a.'">'.__('Login', 'wp-symposium').'</a></div>';
} else {
	...
	echo '<input type="submit" class="submit" value="'.__('Update', 'wp-symposium').'" />';
	echo '</form>';
	echo '</div>';
}

echo '<ul>';
//echo '<li><a href="profile.php?'.$a.'">'.__('Profile', 'wp-symposium').'</a></li>';
echo '<li><a href="forum.php?'.$a.'">'.__('Forum', 'wp-symposium').'</a></li>';
echo '<li><a href="forum_threads.php?'.$a.'">'.__('Forum Threads', 'wp-symposium').'</a></li>';
echo '</ul>';

if ( is_user_logged_in() ) {
	echo '<div class="line">'.__('Logged in as', 'wp-symposium').' '.$current_user->display_name.' - <a href="login.php?'.$a.'">'.__('Logout', 'wp-symposium').'</a></div>';
}
