...
class Symposium_vote_Widget extends WP_Widget {
	...
	function Symposium_vote_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'symposium_vote-widget', 'Symposium: '.__('Vote', 'wp-symposium-yesno'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if (is_user_logged_in()) {
			...
			if ($voted == "on") {
				...
				echo "<p>";
				echo __('Thank you for voting', 'wp-symposium-yesno').".";
				if ($symposium_vote_forum != '') {
					echo "<br /><a href='".$symposium_vote_forum."'>".__('Discuss this on the forum', 'wp-symposium-yesno')."...</a>";
				}
				echo "</p>";
				...
				echo "<div id='symposium_vote_forum'>";
					echo "<p>".__('Your vote', 'wp-symposium-yesno').": ";
					echo "<a href='javascript:void(0)' title='yes' class='symposium_answer' value='".__("Yes", "wp-symposium-yesno")."'>".__("Yes", "wp-symposium-yesno")."</a> ".__('or', 'wp-symposium-yesno')." ";
					echo "<a href='javascript:void(0)' title='no' class='symposium_answer' value='".__("No", "wp-symposium-yesno")."'>".__("No", "wp-symposium-yesno")."</a>";
					if ($symposium_vote_forum != '') {
						echo "<br /><a href='".$symposium_vote_forum."'>".__('Discuss this on the forum', 'wp-symposium-yesno')."...</a>";
					}
					echo "</p>";
				...
				echo "<div id='symposium_vote_thankyou'>";
					echo "<p>".__("Thank you for voting, refresh the page for latest results", "wp-symposium-yesno");
					if ($symposium_vote_forum != '') {
						echo "<br /><a href='".$symposium_vote_forum."'>".__('Discuss this on the forum', 'wp-symposium-yesno')."...</a>";
					}
					echo "</p>";
			...
			echo "<p>".__("Log in to vote...", "wp-symposium-yesno")."</p>";
	...
	function form( $instance ) {
		...
		$defaults = array( 'symposium_vote_question' => __('A yes/no question...', 'wp-symposium-yesno'), 'symposium_vote_forum' => '', 'symposium_vote_counts' => '', 'symposium_vote_type' => 'bar', 'symposium_vote_key' => '' );
		$instance = wp_parse_args( (array) $instance, $defaults ); 

		$symposium_vote_yes = get_option("symposium_vote_yes");
		$symposium_vote_no = get_option("symposium_vote_no");

		echo "<p><span style='font-weight:bold'>".__('Results so far', 'wp-symposium-yesno')."</span><br />";
		echo __("Yes", "wp-symposium-yesno").": ".$symposium_vote_yes."<br />";
		echo __("No", "wp-symposium-yesno").": ".$symposium_vote_no."</p>";
		?>		
		<p>
			<label 	for="<?php echo $this->get_field_id( 'symposium_vote_question' ); ?>"><?php echo __('Question', 'wp-symposium-yesno'); ?>:<br /></label>
		...
		<br /><br />
			<label 	for="<?php echo $this->get_field_id( 'symposium_vote_forum' ); ?>"><?php echo __('Forum Link', 'wp-symposium-yesno'); ?>:<br /></label>
		...
		<br /><br />
			<label for="<?php echo $this->get_field_id( 'symposium_vote_counts' ); ?>"><?php echo __('Show values', 'wp-symposium-yesno'); ?>:</label>
		...
		<br /><br />
			<label for="<?php echo $this->get_field_id( 'symposium_vote_type' ); ?>"><?php echo __('Chart type', 'wp-symposium-yesno'); ?>:</label>
		...
		<br /><br />
			<label for="<?php echo $this->get_field_id( 'symposium_reset_votes' ); ?>"><?php echo __('Reset votes?', 'wp-symposium-yesno'); ?>:</label>
			<input type="checkbox" id="<?php echo $this->get_field_id( 'symposium_reset_votes' ); ?>" name="<?php echo $this->get_field_name( 'symposium_reset_votes' ); ?>"
			 />
		<br /><br />
			<label 	for="<?php echo $this->get_field_id( 'symposium_vote_key' ); ?>"><?php echo __('Domain key', 'wp-symposium-yesno'); ?>:<br /></label>
			...
			<br /><a href="http://www.wpswiki.com/index.php?title=Yes/No_Vote" target="_blank"><?php echo __('What is this?', 'wp-symposium-yesno'); ?></a>
		</p>
		<?php
	}
...
if ( function_exists('load_plugin_textdomain') ) {
	load_plugin_textdomain( 'wp-symposium-yesno' );		
}

// ----------------------------------------------------------------------------------------------------------------------------------------------------------

function symposium_yesno_upgrademe()
{
    return 'http://www.wpsymposium.com/wp-content/plugins/latest/yesno.php';
}
?>
