...
class wps_user {
	...
	public function __construct($id='') {
		...
		$this->city = get_symposium_meta('city');					// City
		$this->country = get_symposium_meta('country');				// Country
		$this->avatar = '';											// Avatar (readonly)
		$this->latest_activity = '';								// Most recent activity post
		$this->activity_privacy = get_symposium_meta('wall_share');	// Privacy for sharing activity
		$this->dob_day = get_symposium_meta('dob_day');				// Date of Birth (day)
		$this->dob_month = get_symposium_meta('dob_month');			// Date of Birth (month)
		$this->dob_year = get_symposium_meta('dob_year');				// Date of Birth (year)		
		$this->last_activity = get_symposium_meta('last_activity');	// When last active		
