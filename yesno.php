	...
	function form( $instance ) {
		...
		<br /><br />
			...
			<input type="checkbox" id="<?php echo $this->get_field_id( 'symposium_reset_votes' ); ?>" name="<?php echo $this->get_field_name( 'symposium_reset_votes' ); ?>"
			 />
		<br /><br />
			<label 	for="<?php echo $this->get_field_id( 'symposium_vote_key' ); ?>"><?php echo __('Domain key', WPS_TEXT_DOMAIN); ?>:<br /></label>
			...
			<br /><a href="http://www.wpswiki.com/index.php?title=Yes/No_Vote" target="_blank"><?php echo __('What is this?', WPS_TEXT_DOMAIN); ?></a>
		</p>
		<?php
	}
