...
if ( !defined('WPS_WL_SHORT') ) 			define('WPS_WL_SHORT', 'WP Symposium');									// Alterantive short name
if ( !defined('WPS_DIR') ) 					define('WPS_DIR', 'wp-symposium'); 										// Installed plugin folder (within WordPress plugins)
if ( !defined('WPS_WELCOME_MESSAGE') ) 		define('WPS_WELCOME_MESSAGE', ''); 										// Alternative file location of welcome message
if ( !defined('WPS_TEXT_DOMAIN') ) 			define('WPS_TEXT_DOMAIN', 'symposium'); 								// Text domain for translations
 ...
 * You can also globally replace __wps__ with __xxx__ in all files to rebrand internal code functions (make it unique!) 
 */

 
/**
 * Plugin names
 * You can also globally replace Plugin Name: WP Symposium with xxx in all files to rebrand plugin names
 */
...
/**
 * Do not edit the following, they are calculated from above value ==================================================================
 */

if ( !defined('WPS_PLUGIN_DIR') ) 			define('WPS_PLUGIN_DIR', WP_PLUGIN_DIR.'/'.WPS_DIR);
if ( !defined('WPS_PLUGIN_URL') ) 			define('WPS_PLUGIN_URL', WP_PLUGIN_URL.'/'.WPS_DIR);
