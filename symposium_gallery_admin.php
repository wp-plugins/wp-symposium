...
symposium_show_tabs_header('gallery');
?>
...
<?php
	...
	<span class="description"><?php echo __('Re-sizing photos will ensure that are displayed at nice size and speed up loading, but will stretch small images', 'wp-symposium'); ?></span></td> 
	</tr> 
