...
class Symposium_friends_status_Widget extends WP_Widget {
	...
	function Symposium_friends_status_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'friends_status-widget', WPS_WL_SHORT.': '.__('Friends Status', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class Symposium_recent_Widget extends WP_Widget {
	...
	function Symposium_recent_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'symposium_recent-widget', WPS_WL_SHORT.': '.__('Recently Online', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class Recentactivity_Widget extends WP_Widget {
	...
	function Recentactivity_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'recentactivity-widget', WPS_WL_SHORT.': '.__('Recent Activity', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class Symposium_members_Widget extends WP_Widget {
	...
	function Symposium_members_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'symposium_members-widget', WPS_WL_SHORT.': '.__('Latest New Members', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class Symposium_friends_Widget extends WP_Widget {
	...
	function Symposium_friends_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'symposium_friends-widget', WPS_WL_SHORT.': '.__('Your Friends', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class Forumrecentposts_Widget extends WP_Widget {
	...
	function Forumrecentposts_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'forumrecentposts-widget', WPS_WL_SHORT.': '.__('Latest Forum Posts', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class symposium_summary_Widget extends WP_Widget {
	...
	function symposium_summary_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'symposium_summary-widget', WPS_WL_SHORT.': '.__('Summary', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class Forumnoanswer_Widget extends WP_Widget {
	...
	function Forumnoanswer_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'forumnoanswer-widget', WPS_WL_SHORT.': '.__('Topics without an accepted answer', 'wp-symposium'), $widget_ops, $control_ops );
	}
...
class Forumexperts_Widget extends WP_Widget {
	...
	function Forumexperts_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'forumexperts-widget', WPS_WL_SHORT.': '.__('Top Experts', 'wp-symposium'), $widget_ops, $control_ops );
	}
