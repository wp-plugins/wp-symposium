...
class Recentactivity_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		// Content of widget
		$sql = "SELECT cid, author_uid, comment, comment_timestamp, display_name 
	...
	function form( $instance ) {
		...
		<br /><br />
			<label for="<?php echo $this->get_field_id( 'forum' ); ?>"><?php echo __('Include forum activity', 'wp-symposium'); ?>:</label>
