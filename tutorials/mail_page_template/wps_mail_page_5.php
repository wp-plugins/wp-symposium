 ...
 * Template Name: WPS demo mail page 5
...
<div id="primary">
	...
	if ( !isset($_GET['mail_id']) && !isset($_GET['mid'])) { // mid is added for compatibility with other WPS functions
		...
		echo '<div id="my-compose-form">';
			...
			echo $wps_ui->mail_subject("Subject of mail", "my-compose-form-subject").'<br />';
		...
		if ($message) {
			...
			echo '<div id="my-mail">';
				...
				echo '<div id="my-mail-message">'.symposium_make_url(stripslashes($message->mail_message)).'</div>';
