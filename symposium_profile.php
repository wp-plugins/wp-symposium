...
Description: Member Profile component for the Symposium suite of plug-ins. Also enables Friends. Put [symposium-profile], [symposium-settings], [symposium-personal], [symposium-friends] or [symposium-extended] on any WordPress page to display relevant content. If WPS Gallery in use, can also use [symposium-gallery].
Version: 12.10
Author: WP Symposium
...
// [symposium-gallery]
function symposium_menu_gallery()  
{  
										
	return symposium_show_profile("gallery");
	exit;
...
if (!is_admin()) {
	...
	add_shortcode('symposium-gallery', 'symposium_menu_gallery');  
