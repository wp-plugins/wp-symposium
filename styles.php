<?php
	...
	if (get_option(WPS_OPTIONS_PREFIX.'_use_styles') == "on") {
		...
		$style .= ".__wps__wrapper #new-topic-link, .__wps__wrapper #reply-topic-link, .__wps__wrapper .__wps__button,  .__wps__button {".PHP_EOL;
		$style .= "	font-family: ".$fontfamily." !important;".PHP_EOL;
		...
		$style .= ".__wps__wrapper #new-topic-link:hover, .__wps__wrapper #reply-topic-link:hover, .__wps__wrapper .__wps__button:hover,  .__wps__button:hover {".PHP_EOL;
		$style .= "	background-color: ".$bigbutton_background_hover." !important;".PHP_EOL;
		$style .= "	color: ".$bigbutton_color_hover." !important;".PHP_EOL;
		$style .= "}".PHP_EOL;
		$style .= ".__wps__wrapper #new-topic-link:active, .__wps__wrapper #reply-topic-link:active, .__wps__wrapper .__wps__button:active,  .__wps__button:active {".PHP_EOL;
		$style .= "	background-color: ".$bigbutton_background_hover." !important;".PHP_EOL;
		$style .= "	color: ".$bigbutton_color_hover." !important;".PHP_EOL;
		$style .= "}".PHP_EOL;
