...
if ($action == "sendReport") {
	...
	__wps__sendmail(get_bloginfo('admin_email'), __('Warning Report', WPS_TEXT_DOMAIN), __('From:', WPS_TEXT_DOMAIN).': '.$current_user->display_name.'<br /><br />'.$report_text.'<br /><br />Ref: '.$code);							
