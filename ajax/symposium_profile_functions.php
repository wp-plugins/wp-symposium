...
if ($_POST['action'] == 'menu_avatar') {
	...
	if (is_user_logged_in()) {
		...
		$html .= '<a id="symposium_remove_avatar" href="javascript:void(0)">or click here to remove</a>)';
		$html .= '</p>';
				...
				if (function_exists('symposium_forum')) {
					$html .= '<div class="symposium_settings_row">';
						$html .= '<input type="checkbox" name="forum_all" id="forum_all"';
							...
							$html .= '/> ';
							$html .= __('Receive an email for all new forum topics and replies?', 'wp-symposium');
					$html .= '</div>';
				}
