		...
		if (WPS_CURRENT_USER_PAGE == $current_user->ID) {
			...
			$compose = '<div id="compose_form" style="display:none">';
				...
				$compose .= '<div id="compose_mail_to">';
					...
					$compose .= '<input type="submit" id="mail_send_button" class="symposium-button" value="'.__('Send', 'wp-symposium').'" />';
					$compose .= '<input type="submit" id="mail_cancel_button" style="float:right;margin:0;" class="symposium-button" value="'.__('Cancel', 'wp-symposium').'" />';
					$compose .= '</div>';
