	...
	if (is_user_logged_in()) {
		...
		$compose = '<div id="compose_form" style="display:none">';
			...
			$compose .= '<div id="compose_mail_to">';
				$compose .= '<div class="new-topic-subject label">'.__('Start typing the recipient\'s name...', 'wp-symposium').'</div>';
		...
		$html = str_replace("[inbox]", __("In Box", "wp-symposium"), stripslashes($html));
