...
function symposium_profile_friends($uid, $limit_from) {
	...
	if ( ($uid == $current_user->ID) || (strtolower($privacy) == 'everyone') || (strtolower($privacy) == 'public') || (strtolower($privacy) == 'friends only' && $is_friend) || symposium_get_current_userlevel() == 5) {
					...
					foreach ($comments as $comment) {
						...
						if ( ($comment->subject_uid == $uid1) 
							...
							$html .= "<div class='wall_post_div' id='post_".$comment->cid."'>";
								...
								$html .= '<div class="symposium_wall_replies" id="'.$comment->cid.'">';
