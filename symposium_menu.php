 	...
 	$wpdb->show_errors();
  	...
  	echo '<div class="wrap">';
		...
		echo "<div style='margin-top:15px'>";
			...
			$groups_ver = get_option("symposium_groups_version");
			if ($groups_ver != '') $groups_ver = "v".$groups_ver;
			$facebook_ver = get_option("symposium_facebook_version");
			if ($facebook_ver != '') $facebook_ver = "v".$facebook_ver;
			...
			install_row(__('Groups', 'wp-symposium').' '.$groups_ver, 'symposium-groups', 'symposium_groups', $config->groups_url, 'wp-symposium-groups/symposium_groups.php', '', __('The groups plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-groups.'.chr(10).chr(10).'Download from http://www.wpsymposium.com/downloadinstall.');
			install_row(__('Group', 'wp-symposium').' '.$groups_ver, 'symposium-group', 'symposium_group', $config->group_url, 'wp-symposium-groups/symposium_groups.php', '', __('The groups plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-groups.'.chr(10).chr(10).'Download from http://www.wpsymposium.com/downloadinstall.');
			install_row(__('Facebook_Connect', 'wp-symposium').' '.$facebook_ver, '', 'symposium_facebook', '-', 'wp-symposium-facebook/symposium-facebook.php', 'admin.php?page=symposium_options&view=facebook', __('The Facebook plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-facebook.'.chr(10).chr(10).'Once activated, see further instructions on the WP Symposium -> Settings -> Facebook page.');
			install_row(__('Mobile', 'wp-symposium').' '.$mobile_ver, '', 'symposium_mobile', '-', 'wp-symposium-mobile/symposium-mobile.php', 'admin.php?page=symposium_options&view=mobile', __('The Mobile plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-facebook.'.chr(10).chr(10).'Once activated, see further instructions on the WP Symposium -> Settings -> Mobile page.');
		...
		echo "<div style='width:45%; float:left'>";
			...
			echo '<iframe id="symposium_versions" onload="document.getElementById(\'symposium_versions_waiting\').style.display=\'none\'; document.getElementById(\'symposium_versions\').style.display=\'block\';" style="display: none; height: 220px; width:100%;" src="'.$ver_goto.'"></iframe>';
		...
		$sql .= "DROP TABLE ".$wpdb->prefix."wps_tmp; DELETE FROM ".$wpdb->prefix."symposium_usermeta WHERE uid = 0;";
		$wpdb->query( $wpdb->prepare($sql) );
...
					</select> 
				...
				if ($view == "profile") {
					...
					<span class="description"><?php echo __('Enable this feature (not yet available.....)', 'wp-symposium'); ?></span></td> 
					</tr> 
