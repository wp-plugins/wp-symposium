 	...
 	$wpdb->show_errors();
  	...
  	echo '<div class="wrap">';
		...
		echo "<div style='width:45%; float:left'>";
			...
			echo '<iframe id="symposium_versions" onload="document.getElementById(\'symposium_versions_waiting\').style.display=\'none\'; document.getElementById(\'symposium_versions\').style.display=\'block\';" style="display: none; height: 300px; width:100%;" src="'.$ver_goto.'"></iframe>';
