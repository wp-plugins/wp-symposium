  	...
  	echo '<div class="wrap">';
		...
		if (current_user_can('update_core')) {
			...
			echo "<div style='width:45%; float:left;'>";
				...
				if (!$ok) {
					if (!WPS_DEBUG) {
						echo "<p>".__('Switch to <a href="admin.php?page=symposium_settings">debug mode</a> and check phpInfo below.', 'wp-symposium')."</p>";
					} else {
						echo "<p>".__('You can check <a href="#phpinfo">phpInfo below</a>.', 'wp-symposium')."</p>";
					}
				}
			...
			echo "<div style='width:50%; float:left;'>";
				...
				echo "<div>";
					...
					if (isset($_POST['symposium_ric'])) {
						...
						// Remove any duplicates in wp_usermeta (symposium options only)
			...
			// PHP info		  	
			if (WPS_DEBUG) {
				echo '<a name="phpinfo"></a>';
			  	echo '<div id="icon-themes" class="icon32"><br /></div>';
			   	echo '<h2>'.__('PHPinfo', 'wp-symposium').'</h2>';
				  	

				echo '<input id="symposium_phpinfo_show_button" style="clear:both;margin:10px;" onclick="document.getElementById(\'symposium_phpinfo_show\').style.display=\'block\';document.getElementById(\'symposium_phpinfo_show_button\').style.display=\'none\';document.getElementById(\'symposium_phpinfo_show_button_hide\').style.display=\'block\';" value="'.__('Show phpInfo', 'wp-symposium').'" type="button">';
				echo '<input id="symposium_phpinfo_show_button_hide" style="clear:both;margin:10px;display:none;" onclick="document.getElementById(\'symposium_phpinfo_show\').style.display=\'none\';document.getElementById(\'symposium_phpinfo_show_button\').style.display=\'block\';document.getElementById(\'symposium_phpinfo_show_button_hide\').style.display=\'none\';" value="'.__('Hide phpInfo', 'wp-symposium').'" type="button">';
			  	echo '<div id="symposium_phpinfo_show" style="clear:both;margin-top:10px;width:98%;display:none;overflow:hidden;">';
				  	phpinfo();
			  	echo '</div>';
			}
		...
		// See if the user has posted profile settings
			...
			echo "<div class='updated slideaway'><p>".__('Saved', 'wp-symposium').".</p></div>";
				...
				echo '<div class="metabox-holder"><div id="toc" class="postbox">';
					...
					<?php if ( symposium_is_plus() && function_exists('symposium_profile_plus') ) { ?>
						<tr valign="top"> 
						<td scope="row"></td>
						<td>
					...
					<?php } else { ?>
						<input type="checkbox" name="menu_mentions" id="menu_mentions" />
					<?php } ?>
