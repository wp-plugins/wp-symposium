...
function symposium_plugin_menu() {
	...
	if (current_user_can('update_core')) {
		...
		if (function_exists('symposium_mail')) {
			...
			add_submenu_page('symposium_debug', __('Mail Messages', 'wp-symposium'), __('Mail Messages', 'wp-symposium'), 'edit_themes', 'symposium_mail_messages_menu', 'symposium_mail_messages_menu');
		}
	}
	// Site Admin
