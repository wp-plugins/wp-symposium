 	...
 	$wpdb->show_errors();
  	...
  	echo '<div class="wrap">';
		...
		echo "<div style='margin-top:15px'>";
			...
			install_row('Groups '.$groups_ver, 'symposium-groups', 'symposium_groups', $config->groups_url, 'wp-symposium-groups/symposium_groups.php', 'admin.php?page=symposium_options&view=groups', __('The groups plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-groups.'.chr(10).chr(10).'Download from http://www.wpsymposium.com/downloadinstall.');
