...
/* ============================================================================================================================ */
	...
	/*
		...
		echo '<thead>';
		echo '<tr>';
		echo '<th>'.__('Version information', 'wp-symposium').'</th>';
		echo '</tr>';
		echo '</thead>';
		echo '<tbody>';
		echo '<tr>';
	...
	*/
		...
		echo "<div>";
			...
			if (isset($_POST['symposium_ric'])) {
				...
				echo __("Integrity check completed.", "wp-symposium")."<br /><br />".$report;
				echo "</div>";
	...
	echo '<tr>';
		...
		echo '<td>';
			...
			if ($ver != 'v'.WPS_VER && $ver != '') {
				echo '<br />';
				echo '<img src="'.WPS_IMAGES_URL.'/warning.png" /> <a href="http://www.wpsymposium.com/downloadinstall" target="_blank">';
