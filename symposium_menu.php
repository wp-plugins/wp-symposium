...
function symposium_plugin_forum() {
	...
	global $wpdb;
		...
		<div class="metabox-holder"><div id="toc" class="postbox"> 
			...
			<td><input name="symposium_forumlatestposts_count" type="text" id="symposium_forumlatestposts_count"  value="<?php echo $symposium_forumlatestposts_count; ?>" /> 
			<span class="description"><?php echo __('Number of topics to show', 'wp-symposium'); ?></span></td> 
			</tr> 
