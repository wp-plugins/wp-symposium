...
					</select> 
				...
				if ($view == "mobile") {
					...
					<ol>
						...
						<li>For example, for /m create <?php echo $_SERVER['DOCUMENT_ROOT']; ?>m to create <?php echo get_bloginfo('wpurl'); ?>/m</li>
					...
					<p>On your mobile device/phone browse to (for example) <a target='_blank' href='<?php echo get_bloginfo('wpurl'); ?>/m'><?php echo get_bloginfo('wpurl'); ?>/m</a></p>
