 	...
 	$wpdb->show_errors();
  	...
  	echo '<div class="wrap">';
		...
		echo "<div style='margin-top:15px'>";
			...
			install_row('Forum', 'symposium-forum', 'symposium_forum', $config->forum_url, 'wp-symposium/symposium_forum.php', 'admin.php?page=symposium_options&view=forum', __('The forum plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium.');
			install_row('Profile', 'symposium-profile', 'symposium_profile', $config->profile_url, 'wp-symposium/symposium_profile.php', 'admin.php?page=symposium_options&view=profile', __('The profile plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium.');
			...
			install_row('Members', 'symposium-members', 'symposium_members', $config->members_url, 'wp-symposium/symposium_members.php', '', __('The members directory plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium.');
			install_row('Panel', '', 'add_notification_bar', '-', 'wp-symposium/symposium_bar.php', 'admin.php?page=symposium_options&view=bar', __('The panel plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium.');
			install_row('Groups '.$groups_ver, 'symposium-groups', 'symposium_groups', $config->groups_url, 'wp-symposium-groups/symposium_groups.php', '', __('The groups plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-groups.'.chr(10).chr(10).'Download from http://www.wpsymposium.com/downloadinstall.');
			install_row('Group '.$groups_ver, 'symposium-group', 'symposium_group', $config->group_url, 'wp-symposium-groups/symposium_groups.php', '', __('The groups plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-groups.'.chr(10).chr(10).'Download from http://www.wpsymposium.com/downloadinstall.');
			install_row('Facebook_Connect '.$facebook_ver, '', 'symposium_facebook', '-', 'wp-symposium-facebook/symposium-facebook.php', 'admin.php?page=symposium_options&view=facebook', __('The Facebook plugin must be installed in ', 'wp-symposium').WP_PLUGIN_DIR.'/wp-symposium-facebook.'.chr(10).chr(10).'Once activated, see further instructions on the WP Symposium -> Settings -> Facebook page.');
...
					</select> 
				...
				if ($view == "settings") {
					...
					<span class="description"><?php echo __("Pressing return submits a post/comment. Option to also show submit buttons.</span>", 'wp-symposium'); ?></span></td> 
					</tr>
