...
function symposium_plugin_menu() {
	...
	if (WPS_HIDE_PLUGINS == 'WPS_HIDE_PLUGINS' || $current_user->user_login == WPS_SUPERUSER) {
		...
		if (wps_is_wpmu()) {
			// WPMS
			add_menu_page(WPS_WL_SHORT,WPS_WL_SHORT.$count1, 'manage_options', 'symposium_debug', 'symposium_plugin_debug', '', 7); 
			...
			add_submenu_page('symposium_debug'.$hidden, __('Settings', 'wp-symposium'), __('Settings', 'wp-symposium'), 'manage_options', 'symposium_settings', 'symposium_plugin_settings');
			add_submenu_page('symposium_debug'.$hidden, __('Templates', 'wp-symposium'), __('Templates', 'wp-symposium'), 'manage_options', 'symposium_templates', 'symposium_plugin_templates');
	
			// Aggregate menu items
			if (get_option('symposium_long_menu') == "on") {
				add_submenu_page('symposium_debug', __('Options', 'wp-symposium'), __('Options', 'wp-symposium'), 'manage_options', 'symposium_options', 'symposium_menu_options');
				add_submenu_page('symposium_debug', __('Manage', 'wp-symposium'), __('Manage', 'wp-symposium'), 'manage_options', 'symposium_manage', 'symposium_menu_manage');
				if ($count2) add_submenu_page('symposium_debug', __('Moderate', 'wp-symposium'), sprintf(__('Moderate%s', 'wp-symposium'), $count1), 'manage_options', 'symposium_moderation', 'symposium_plugin_moderation');
			}
			...
			if (function_exists('symposium_profile')) {
				add_submenu_page('symposium_debug'.$hidden, __('Profile', 'wp-symposium'), __('Profile', 'wp-symposium'), 'manage_options', 'symposium_profile', 'symposium_plugin_profile');
			}
			if (function_exists('symposium_forum')) {
				add_submenu_page('symposium_debug'.$hidden, __('Forum', 'wp-symposium'), __('Forum', 'wp-symposium'), 'manage_options', 'symposium_forum', 'symposium_plugin_forum');
				add_submenu_page('symposium_debug'.$hidden, __('Forum Categories', 'wp-symposium'), __('Forum Categories', 'wp-symposium'), 'manage_options', 'symposium_categories', 'symposium_plugin_categories');
				add_submenu_page('symposium_debug'.$hidden, __('Forum Posts', 'wp-symposium'), sprintf(__('Forum Posts %s', 'wp-symposium'), $count2), 'manage_options', 'symposium_moderation', 'symposium_plugin_moderation');
			}
			if (function_exists('add_notification_bar')) {
				add_submenu_page('symposium_debug'.$hidden, __('Panel', 'wp-symposium'), __('Panel', 'wp-symposium'), 'manage_options', 'symposium_bar', 'symposium_plugin_bar');
			}
			if (function_exists('symposium_members')) {
				add_submenu_page('symposium_debug'.$hidden, __('Member Directory', 'wp-symposium'), __('Member Directory', 'wp-symposium'), 'manage_options', 'symposium_members_menu', 'symposium_members_menu');
			}
			if (function_exists('symposium_mail')) {
				add_submenu_page('symposium_debug'.$hidden, __('Mail', 'wp-symposium'), __('Mail', 'wp-symposium'), 'update_core', 'symposium_mail_menu', 'symposium_mail_menu');
				add_submenu_page('symposium_debug'.$hidden, __('Mail Messages', 'wp-symposium'), __('Mail Messages', 'wp-symposium'), 'update_core', 'symposium_mail_messages_menu', 'symposium_mail_messages_menu');
			}
		} else {
			// Single intallation
			add_menu_page(WPS_WL_SHORT,WPS_WL_SHORT.$count1, 'manage_options', 'symposium_debug', 'symposium_plugin_debug', '', 7); 
			...
			if (function_exists('symposium_mail')) {
				add_submenu_page('symposium_debug'.$hidden, __('Mail', 'wp-symposium'), __('Mail', 'wp-symposium'), 'manage_options', 'symposium_mail_menu', 'symposium_mail_menu');
				add_submenu_page('symposium_debug'.$hidden, __('Mail Messages', 'wp-symposium'), __('Mail Messages', 'wp-symposium'), 'manage_options', 'symposium_mail_messages_menu', 'symposium_mail_messages_menu');
			}
		}
...
function symposium_menu_options() {
  	echo '<div class="wrap">';
  	echo '<div id="icon-themes" class="icon32"><br /></div>';
  	echo '<h2>'.sprintf(__('%s Options', 'wp-symposium'), WPS_WL).'</h2><br />';

	symposium_show_tabs_header('options');
	$show = '';
	if (function_exists('symposium_profile')) $show .= '<li><a href="admin.php?page=symposium_profile">'.__('Member Profile', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_forum')) $show .= '<li><a href="admin.php?page=symposium_forum">'.__('Forum', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_members')) $show .= '<li><a href="admin.php?page=symposium_members_menu">'.__('Member Directory', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_mail')) $show .= '<li><a href="admin.php?page=symposium_mail_menu">'.sprintf(__('Private %s mail', 'wp-symposium'), WPS_WL).'</a></li>';
	if (function_exists('add_notification_bar')) $show .= '<li><a href="admin.php?page=symposium_bar">'.__('Panel (notification bar)', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_mobile')) $show .= '<li><a href="admin.php?page=symposium_mobile_menu">'.__('Access for mobile devices', 'wp-symposium').'</a></li>';

	if ($show) {
		echo '<h3>Tabs</h3>';
		echo '<p><em>'.__('The relevant plugin has to be <a href="plugins.php">activated</a>, for its tab above to appear.', 'wp-symposium').'</em></p>';	
		echo '<ul style="list-style-type: square; margin: 10px 0 10px 30px;">';
		echo $show;
		if (function_exists('symposium_forum')) echo '<li><a href="admin.php?page=symposium_categories">'.sprintf(__('Manage Forum Categories', 'wp-symposium'), WPS_WL).'</a></li>';
		if (function_exists('symposium_forum')) echo '<li><a href="admin.php?page=symposium_moderation">'.sprintf(__('Manage Forum Posts', 'wp-symposium'), WPS_WL).'</a></li>';
		echo '</ul>';
	}

	$show2 = '';
	if (function_exists('symposium_profile_plus')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_plus_admin.php">'.__('Additional profile related options', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_group')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_gallery_admin.php">'.__('Gallery', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_gallery')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_groups_admin.php">'.sprintf(__('%s Groups', 'wp-symposium'), WPS_WL).'</a></li>';
	if (function_exists('symposium_news_main')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_news_admin.php">'.__('Alerts', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_events_main')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_events_admin.php">'.sprintf(__('%s Events', 'wp-symposium'), WPS_WL).'</a></li>';
	if (function_exists('symposium_facebook')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_facebook_admin.php">'.__('Post profile messages to Facebook', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_mailinglist')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_mailinglist_admin.php">'.__('Reply to forum topics and replies by email', 'wp-symposium').'</a></li>';
	if (function_exists('symposium_lounge_main')) $show2 .= '<li><a href="admin.php?page=wp-symposium/symposium_lounge_admin.php">'.__('The Lounge options (demonstrator)', 'wp-symposium').'</a></li>';
	
	if ($show2) {
		echo '<h3>Bronze Plugin Tabs</h3>';
		echo '<ul style="list-style-type: square; margin: 10px 0 10px 30px;">';
		echo $show2;
		echo '</ul>';
	}
	...
	if (!$show && !$show2) {
		echo '<h3>Activate some '.WPS_WL.' plugins</h3>';
		echo '<p>'.sprintf(__('For the relevant option tabs to appear above, <a href="plugins.php">activate</a> some %s plugins.', 'wp-symposium'), WPS_WL).'</p>';
	}
	
	symposium_show_tabs_header_end();
}

function symposium_menu_manage() {
  	echo '<div class="wrap">';
  	echo '<div id="icon-themes" class="icon32"><br /></div>';
  	echo '<h2>'.sprintf(__('%s Management', 'wp-symposium'), WPS_WL).'</h2><br />';

	symposium_show_manage_tabs_header('manage');
	echo '<h3>Tabs</h3>';
	echo '<ul style="list-style-type: square; margin: 10px 0 10px 30px;">';
	echo '<li><a href="admin.php?page=symposium_settings">'.sprintf(__('Overall settings for %s', 'wp-symposium'), WPS_WL).'</a></li>';
	if (function_exists('symposium_forum')) echo '<li><a href="admin.php?page=symposium_categories">'.sprintf(__('%s forum categories and permissions', 'wp-symposium'), WPS_WL).'</a></li>';
	if (function_exists('symposium_forum')) echo '<li><a href="admin.php?page=symposium_moderation">'.sprintf(__('View and moderation %s forum topics and replies', 'wp-symposium'), WPS_WL).'</a></li>';
	if (function_exists('symposium_mail')) echo '<li><a href="admin.php?page=symposium_mail_messages_menu">'.sprintf(__('View and delete %s mail messages', 'wp-symposium'), WPS_WL).'</a></li>';
	echo '<li><a href="admin.php?page=symposium_templates">'.sprintf(__('%s layout templates', 'wp-symposium'), WPS_WL).'</a></li>';
	echo '</ul>';
	
	symposium_show_manage_tabs_header_end();
}

function symposium_plugin_welcome() {

		if ($file = @file_get_contents(WPS_WELCOME_MESSAGE)) {
			// WPS_WELCOME_MESSAGE should defined in wp-config.php and is an absolute local path and filename
			echo $file;
		} else {
			...
			<div id="wps-welcome-panel" class="welcome-panel" style="margin-top:40px">
				...
				<?php echo sprintf(__( 'Thank you for installing %s, welcome aboard! Please visit the %s <a href="%s">Installation page</a> to complete your installation/upgrade.' ), WPS_WL, WPS_WL_SHORT, "admin.php?page=symposium_debug"); ?>
			    <?php
			    $ver = str_replace('.', '-', WPS_VER);
			    if (strpos($ver, ' ') !== false) $ver = substr($ver, 0, strpos($ver, ' ')); 
			    echo ' '.sprintf(__('For more information and release notes, check out the <a href="%s" target="_blank">WP Symposium blog</a>.', 'wp-symposium'), 'http://www.wpsymposium.com/category/releases/');
				...
				<div class="welcome-panel-column-container">
					<div class="welcome-panel-column">
						...
						<p><?php echo sprintf(__( 'What\'s new in this release? For more detail and release notes, head on over to the <a href="%s" target="_blank">WP Symposium blog</a>.', 'wp-symposium' ), "http://www.wpsymposium.com/category/releases/"); ?></p>
						<ul>
						<li><?php _e('New [symposium-gallery] shortcode to show profile page with gallery as default', 'wp-symposium'); ?></li>
						<li><?php _e('Fix for non-admin users to see "My Gallery"', 'wp-symposium'); ?></li>
						<li><?php _e('Fix for s2members plugin compatibility', 'wp-symposium'); ?></li>
						<li><?php _e('Blank group names no longer permitted', 'wp-symposium'); ?></li>
						<li><?php echo sprintf(	__( '<a href="%s">Delete groups via Groups Admin</a>' ), esc_url( admin_url('admin.php?page=wp-symposium/symposium_groups_admin.php') ) ); ?></li>
						<li><?php echo sprintf(	__( '<a target="_blank" href="%s">Cubepoints WPS module now supports likes/dislikes</a>' ), 'http://www.wpsymposium.com/2012/02/wp-symposium-cubepoints-module/' ); ?></li>
						<li><?php _e('Added symposium_profile_header and symposium_profile_header_public filters', 'wp-symposium'); ?></li>
						<li><?php echo sprintf(	__( 'Tabbed options in admin (activate in <a href="%s">Settings</a>)' ), esc_url( admin_url('admin.php?page=symposium_settings') ) ); ?></li>
						<li><?php echo sprintf(	__( '<a href="%s">Add comments to forum replies</a>' ), esc_url( admin_url('admin.php?page=symposium_forum') ) ); ?></li>
						</ul>
					</div>
					<div class="welcome-panel-column">
						<h4><span class="icon16 icon-page"></span> <?php _e( 'Getting Started' ); ?></h4>
						<p><?php echo sprintf(__( 'First time setting up %s? Try the following to get you up and running.', 'wp-symposium' ), WPS_WL); ?></p>
						<ul>
...
function symposium_plugin_templates() {
	...
	if (isset($_POST['page_footer_textarea'])) {
		if ($_POST['page_footer_textarea'] == "") {
			update_option('symposium_template_page_footer', str_replace(chr(13), "[]", sprintf("<!-- Powered by %s v%s -->", WPS_WL, get_option("symposium_version"))));
		} else {
	...
	$template_group_forum_topic = str_replace("[]", chr(13), stripslashes(get_option('symposium_template_group_forum_topic')));
  	...
  	echo '<div class="wrap">';
	  	...
	  	echo '<div id="icon-themes" class="icon32"><br /></div>';
	  	echo '<h2>'.sprintf(__('%s Management', 'wp-symposium'), WPS_WL).'</h2><br />';
		symposium_show_manage_tabs_header('templates');
...
function symposium_plugin_moderation() {
	...
	global $wpdb;
  	...
  	echo '<div class="wrap">';
	  	...
	  	echo '<div id="icon-themes" class="icon32"><br /></div>';
	  	echo '<h2>'.sprintf(__('%s Management', 'wp-symposium'), WPS_WL).'</h2><br />';
		symposium_show_manage_tabs_header('posts');
		echo '<a href="admin.php?page=symposium_forum">'.__('Go to Forum Options', 'wp-symposium').'</a><br />';	 
...
*/
		...
		echo '<div style="margin-top:10px; margin-bottom:10px">';
			echo sprintf(__("Visit this page to complete installation; after you add a %s shortcode to a page; change pages with %s shortcodes; if you change WordPress Permalinks; or if you experience problems.", "wp-symposium"), WPS_WL, WPS_WL);
		echo '</div>';
		...
		if (current_user_can('update_core')) {
			...
			echo "<div style='width:45%; float:left;'>";
				...
				echo "<p>";
					...
					echo '<br />';
					echo sprintf(__("%s internal code version:", "wp-symposium"), WPS_WL)." ";
...
//								}
			...
			echo "<div style='width:45%; float:left;'>";
				...
				// ********** Reset database version
			  	echo '<div id="icon-themes" class="icon32"></div>';
			   	echo '<h2>'.sprintf(__('Refresh %s', 'wp-symposium'), WPS_WL).'</h2>';
			   	...
			   	echo "<p>".sprintf(__('This will also display the %s <a href="%s">welcome page</a>.', 'wp-symposium'), WPS_WL, "admin.php?page=symposium_welcome")."</p>";
			...
			echo "<div style='width:50%; float:left;'>";
				...
				if( isset($_POST[ 'symposium_testemail' ]) && $_POST[ 'symposium_testemail' ] == 'Y' ) {
					...
					if (symposium_sendmail($to, sprintf("%s Test Email", WPS_WL), __("This is a test email sent from", "wp-symposium")." ".get_bloginfo('url'))) {
				...
				if (isset($_POST['symposium_ric'])) {
					...
					if(file_exists($path) && is_dir($path)) { 
						...
						if (!mkdir($path, 0777, true)) {
							$report .= sprintf(__("The %s images/media path could not be created (%s), check rights and re-run the Integrity Check", "wp-symposium"), WPS_WL, $path);
						} else {
							$report .= sprintf(__("The %s images/media path (%s) was created", "wp-symposium"), WPS_WL, $path);
						}
					}
			...
			if ($forums) {
			   	echo '<p>'.sprintf(__('If you have bbPress v2 plugin forums, you can migrate them to your %s forum as a new category.', 'wp-symposium'), WPS_WL).'</p>';
			...
			if($wpdb->get_var("show tables like '%".$wpdb->prefix."forum_forums%'") == $wpdb->prefix."forum_forums") {
				...
				$forums = $wpdb->get_results($sql);
				if ($forums) {
				   	echo '<p>'.sprintf(__('If you have the Mingle v1.0.33 (or higher) plugin, you can migrate the forums to your %s forum as a new category.', 'wp-symposium'), WPS_WL).'</p>';
			...
			echo '<td style="text-align:center">';
				...
				$current_value = get_option('symposium_'.strtolower($name).'_url');
					if ($current_value != $url) {
						...
						$fixed_url = true;
						if ($url != '') {
							echo '[<a href="javascript:void(0)" class="symposium_help" title="'.sprintf(__("URL updated successfully. It is important to visit this page to complete installation; after you add a %s shortcode to a page; change pages with WP Symposium shortcodes; if you change WordPress Permalinks; or if you experience problems.", "wp-symposium"), WPS_WL).'">'.__('Updated ok!', 'wp-symposium').'</a>]';
						} else {
							echo '[<a href="javascript:void(0)" class="symposium_help" title="'.sprintf(__("URL removed. It is important to visit this page to complete installation; after you add a WP Symposium shortcode to a page; change pages with %s shortcodes; if you change WordPress Permalinks; or if you experience problems.", "wp-symposium"), WPS_WL).'">'.__('URL removed', 'wp-symposium').'</a>]';
						}
					} else {
						if ($current_value) {
							$status = 'tick';
...
function symposium_plugin_bar() {
	...
	symposium_show_tabs_header('panel');
...
function symposium_plugin_profile() {
	...
	symposium_show_tabs_header('profile');
	...
	include_once( ABSPATH . 'wp-includes/formatting.php' );
		...
		// See if the user has posted profile settings
			...
			update_option('symposium_menu_groups', isset($_POST['menu_groups']) ? $_POST['menu_groups'] : '');
			update_option('symposium_menu_events', isset($_POST['menu_events']) ? $_POST['menu_events'] : '');
			update_option('symposium_menu_gallery', isset($_POST['menu_gallery']) ? $_POST['menu_gallery'] : '');
			update_option('symposium_menu_following', isset($_POST['menu_following']) ? $_POST['menu_following'] : '');
			update_option('symposium_menu_followers', isset($_POST['menu_followers']) ? $_POST['menu_followers'] : '');
			update_option('symposium_menu_lounge', isset($_POST['menu_lounge']) ? $_POST['menu_lounge'] : '');
			update_option('symposium_menu_avatar', isset($_POST['menu_avatar']) ? $_POST['menu_avatar'] : '');
			update_option('symposium_menu_details', isset($_POST['menu_details']) ? $_POST['menu_details'] : '');
			update_option('symposium_menu_settings', isset($_POST['menu_settings']) ? $_POST['menu_settings'] : '');
			
			update_option('symposium_menu_my_activity_other', isset($_POST['menu_my_activity_other']) ? $_POST['menu_my_activity_other'] : '');
			update_option('symposium_menu_friends_activity_other', isset($_POST['menu_friends_activity_other']) ? $_POST['menu_friends_activity_other'] : '');
			update_option('symposium_menu_all_activity_other', isset($_POST['menu_all_activity_other']) ? $_POST['menu_all_activity_other'] : '');
			update_option('symposium_menu_profile_other', isset($_POST['menu_profile_other']) ? $_POST['menu_profile_other'] : '');
			update_option('symposium_menu_friends_other', isset($_POST['menu_friends_other']) ? $_POST['menu_friends_other'] : '');
			update_option('symposium_menu_mentions_other', isset($_POST['menu_mentions_other']) ? $_POST['menu_mentions_other'] : '');
			update_option('symposium_menu_groups_other', isset($_POST['menu_groups_other']) ? $_POST['menu_groups_other'] : '');
			update_option('symposium_menu_events_other', isset($_POST['menu_events_other']) ? $_POST['menu_events_other'] : '');
			update_option('symposium_menu_gallery_other', isset($_POST['menu_gallery_other']) ? $_POST['menu_gallery_other'] : '');
			update_option('symposium_menu_following_other', isset($_POST['menu_following_other']) ? $_POST['menu_following_other'] : '');
			update_option('symposium_menu_followers_other', isset($_POST['menu_followers_other']) ? $_POST['menu_followers_other'] : '');
			update_option('symposium_menu_lounge_other', isset($_POST['menu_lounge_other']) ? $_POST['menu_lounge_other'] : '');
			
			update_option('symposium_menu_profile_text', $_POST['menu_profile_text']);
			update_option('symposium_menu_my_activity_text', $_POST['menu_my_activity_text']);
			update_option('symposium_menu_friends_activity_text', $_POST['menu_friends_activity_text']);
			update_option('symposium_menu_all_activity_text', $_POST['menu_all_activity_text']);
			update_option('symposium_menu_friends_text', $_POST['menu_friends_text']);
			update_option('symposium_menu_mentions_text', $_POST['menu_mentions_text']);
			update_option('symposium_menu_groups_text', $_POST['menu_groups_text']);
			update_option('symposium_menu_events_text', $_POST['menu_events_text']);
			update_option('symposium_menu_gallery_text', $_POST['menu_gallery_text']);
			update_option('symposium_menu_following_text', $_POST['menu_following_text']);
			update_option('symposium_menu_followers_text', $_POST['menu_followers_text']);
			update_option('symposium_menu_lounge_text', $_POST['menu_lounge_text']);
			update_option('symposium_menu_avatar_text', $_POST['menu_avatar_text']);
			update_option('symposium_menu_details_text', $_POST['menu_details_text']);
			update_option('symposium_menu_settings_text', $_POST['menu_settings_text']);

			update_option('symposium_menu_profile_other_text', $_POST['menu_profile_other_text']);
			update_option('symposium_menu_my_activity_other_text', $_POST['menu_my_activity_other_text']);
			update_option('symposium_menu_friends_activity_other_text', $_POST['menu_friends_activity_other_text']);
			update_option('symposium_menu_all_activity_other_text', $_POST['menu_all_activity_other_text']);
			update_option('symposium_menu_friends_other_text', $_POST['menu_friends_other_text']);
			update_option('symposium_menu_mentions_other_text', $_POST['menu_mentions_other_text']);
			update_option('symposium_menu_groups_other_text', $_POST['menu_groups_other_text']);
			update_option('symposium_menu_events_other_text', $_POST['menu_events_other_text']);
			update_option('symposium_menu_gallery_other_text', $_POST['menu_gallery_other_text']);
			update_option('symposium_menu_following_other_text', $_POST['menu_following_other_text']);
			update_option('symposium_menu_followers_other_text', $_POST['menu_followers_other_text']);
			update_option('symposium_menu_lounge_other_text', $_POST['menu_lounge_other_text']);
					...
					<td>
						<table>
							<tr style='font-weight:bold'>
								<td><?php _e('Menu Item', 'wp-symposium'); ?></td>
								<td><?php _e('Own Page', 'wp-symposium'); ?></td>
								<td><?php _e('Own Page Text', 'wp-symposium'); ?></td>
								<td><?php _e('Other Members', 'wp-symposium'); ?></td>
								<td><?php _e('Other Members Text', 'wp-symposium'); ?></td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('Profile', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_profile" id="menu_profile" <?php if (get_option('symposium_menu_profile') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_profile_text" type="text" id="menu_profile_text"  value="<?php echo get_option('symposium_menu_profile_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_profile_other" id="menu_profile_other" <?php if (get_option('symposium_menu_profile_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_profile_other_text" type="text" id="menu_profile_other_text"  value="<?php echo get_option('symposium_menu_profile_other_text'); ?>" /></td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('My Activity', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_my_activity" id="menu_my_activity" <?php if (get_option('symposium_menu_my_activity') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_my_activity_text" type="text" id="menu_my_activity_text"  value="<?php echo get_option('symposium_menu_my_activity_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_my_activity_other" id="menu_my_activity_other" <?php if (get_option('symposium_menu_my_activity_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_my_activity_other_text" type="text" id="menu_my_activity_other_text"  value="<?php echo get_option('symposium_menu_my_activity_other_text'); ?>" /></td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('Friends Activity', 'wp-symposium'); ?></span></span></td>
								<td align='center'><input type="checkbox" name="menu_friends_activity" id="menu_friends_activity" <?php if (get_option('symposium_menu_friends_activity') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_friends_activity_text" type="text" id="menu_friends_activity_text"  value="<?php echo get_option('symposium_menu_friends_activity_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_friends_activity_other" id="menu_friends_activity_other" <?php if (get_option('symposium_menu_friends_activity_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_friends_activity_other_text" type="text" id="menu_friends_activity_other_text"  value="<?php echo get_option('symposium_menu_friends_activity_other_text'); ?>" /></td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('All Activity', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_all_activity" id="menu_all_activity" <?php if (get_option('symposium_menu_all_activity') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_all_activity_text" type="text" id="menu_all_activity_text"  value="<?php echo get_option('symposium_menu_all_activity_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_all_activity_other" id="menu_all_activity_other" <?php if (get_option('symposium_menu_all_activity_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_all_activity_other_text" type="text" id="menu_all_activity_other_text"  value="<?php echo get_option('symposium_menu_all_activity_other_text'); ?>" /></td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('Friends', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_friends" id="menu_friends" <?php if (get_option('symposium_menu_friends') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_friends_text" type="text" id="menu_friends_text"  value="<?php echo get_option('symposium_menu_friends_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_friends_other" id="menu_friends_other" <?php if (get_option('symposium_menu_friends_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_friends_other_text" type="text" id="menu_friends_other_text"  value="<?php echo get_option('symposium_menu_friends_other_text'); ?>" /></td>
							</tr>
							<?php if ( function_exists('symposium_profile_plus') ) { ?>
							<tr>
								<td><span class="description"><?php echo __('Forum @mentions', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_mentions" id="menu_mentions" <?php if (get_option('symposium_menu_mentions') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_mentions_text" type="text" id="menu_mentions_text"  value="<?php echo get_option('symposium_menu_mentions_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_mentions_other" id="menu_mentions_other" <?php if (get_option('symposium_menu_mentions_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_mentions_other_text" type="text" id="menu_mentions_other_text"  value="<?php echo get_option('symposium_menu_mentions_other_text'); ?>" /></td>
							</tr>
							<?php } ?>
							<?php if ( function_exists('symposium_group') ) { ?>
							<tr>
								<td><span class="description"><?php echo __('Groups', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_groups" id="menu_groups" <?php if (get_option('symposium_menu_groups') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_groups_text" type="text" id="menu_groups_text"  value="<?php echo get_option('symposium_menu_groups_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_groups_other" id="menu_groups_other" <?php if (get_option('symposium_menu_groups_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_groups_other_text" type="text" id="menu_groups_other_text"  value="<?php echo get_option('symposium_menu_groups_other_text'); ?>" /></td>
							</tr>
							<?php } ?>
							<?php if ( function_exists('symposium_events_main') ) { ?>
							<tr>
								<td><span class="description"><?php echo __('Events', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_events" id="menu_events" <?php if (get_option('symposium_menu_events') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_events_text" type="text" id="menu_events_text"  value="<?php echo get_option('symposium_menu_events_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_events_other" id="menu_events_other" <?php if (get_option('symposium_menu_events_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_events_other_text" type="text" id="menu_events_other_text"  value="<?php echo get_option('symposium_menu_events_other_text'); ?>" /></td>
							</tr>
							<?php } ?>
							<?php if ( function_exists('symposium_gallery') ) { ?>
							<tr>
								<td><span class="description"><?php echo __('Gallery', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_gallery" id="menu_gallery" <?php if (get_option('symposium_menu_gallery') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_gallery_text" type="text" id="menu_gallery_text"  value="<?php echo get_option('symposium_menu_gallery_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_gallery_other" id="menu_gallery_other" <?php if (get_option('symposium_menu_gallery_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_gallery_other_text" type="text" id="menu_gallery_other_text"  value="<?php echo get_option('symposium_menu_gallery_other_text'); ?>" /></td>
							</tr>
							<?php } ?>
							<?php if ( function_exists('symposium_profile_plus') ) { ?>
							<tr>
								<td><span class="description"><?php echo __('Following', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_following" id="menu_following" <?php if (get_option('symposium_menu_following') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_following_text" type="text" id="menu_following_text"  value="<?php echo get_option('symposium_menu_following_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_following_other" id="menu_following_other" <?php if (get_option('symposium_menu_following_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_following_other_text" type="text" id="menu_following_other_text"  value="<?php echo get_option('symposium_menu_following_other_text'); ?>" /></td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('Followers', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_followers" id="menu_followers" <?php if (get_option('symposium_menu_followers') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_followers_text" type="text" id="menu_followers_text"  value="<?php echo get_option('symposium_menu_followers_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_followers_other" id="menu_followers_other" <?php if (get_option('symposium_menu_followers_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_followers_other_text" type="text" id="menu_followers_other_text"  value="<?php echo get_option('symposium_menu_followers_other_text'); ?>" /></td>
							</tr>
							<?php } ?>
							<?php if ( function_exists('symposium_lounge_main') ) { ?>
							<tr>
								<td><span class="description"><?php echo __('The Lounge', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_lounge" id="menu_lounge" <?php if (get_option('symposium_menu_lounge') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_lounge_text" type="text" id="menu_lounge_text"  value="<?php echo get_option('symposium_menu_lounge_text'); ?>" /></td>
								<td align='center'><input type="checkbox" name="menu_lounge_other" id="menu_lounge_other" <?php if (get_option('symposium_menu_lounge_other') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_lounge_other_text" type="text" id="menu_lounge_other_text"  value="<?php echo get_option('symposium_menu_lounge_other_text'); ?>" /></td>
							</tr>
							<?php } ?>
							<tr>
								<td><span class="description"><?php echo __('Profile Photo', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_avatar" id="menu_avatar" <?php if (get_option('symposium_menu_avatar') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_avatar_text" type="text" id="menu_avatar_text"  value="<?php echo get_option('symposium_menu_avatar_text'); ?>" /></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('Profile Details', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_details" id="menu_details" <?php if (get_option('symposium_menu_details') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_details_text" type="text" id="menu_details_text"  value="<?php echo get_option('symposium_menu_details_text'); ?>" /></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td><span class="description"><?php echo __('Community Settings', 'wp-symposium'); ?></span></td>
								<td align='center'><input type="checkbox" name="menu_settings" id="menu_settings" <?php if (get_option('symposium_menu_settings') == "on") { echo "CHECKED"; } ?>/></td>
								<td><input name="menu_settings_text" type="text" id="menu_settings_text"  value="<?php echo get_option('symposium_menu_settings_text'); ?>" /></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
						</table>
...
function symposium_plugin_settings() {
  	...
  	echo '<div id="icon-themes" class="icon32"><br /></div>';
  	echo '<h2>'.sprintf(__('%s Management', 'wp-symposium'), WPS_WL).'</h2><br />';
	symposium_show_manage_tabs_header('settings');
	...
	global $wpdb;
		...
		if( isset($_POST[ 'symposium_update' ]) && $_POST[ 'symposium_update' ] == 'symposium_plugin_settings' ) {
			...
			update_option('symposium_long_menu', isset($_POST[ 'long_menu' ]) ? $_POST[ 'long_menu' ] : '');
			update_option('symposium_debug_mode', isset($_POST[ 'debug_mode' ]) ? $_POST[ 'debug_mode' ] : '');
			update_option('symposium_always_load', isset($_POST[ 'always_load' ]) ? $_POST[ 'always_load' ] : '');			
			...
			echo "<p>".__('Saved', 'wp-symposium').".</p></div>";
					...
					<?php if (get_option('symposium_wps_lite') == "on") { ?>
						...
						<td></td><td style="border:1px dotted #999; background-color: #fff;">
							<strong><?php echo sprintf(__('%s LITE mode', 'wp-symposium'), WPS_WL); ?></strong>
							<p>
							<?php echo sprintf(__('You are running %s in LITE mode, which reduces server load, but disables/reduces certain features of the %s plugins, and will take priority over any other settings you have made.', 'wp-symposium'), WPS_WL, WPS_WL).' '; ?>
							...
							<ul style="list-style-type: circle; margin: 10px 0 20px 30px;">
								<li><?php echo sprintf(__('minimize the total number of all WordPress plugins and widgets used (%s and others). <a href="plugins.php?plugin_status=active">De-activate as many as possible!</a>', 'wp-symposium'), WPS_WL); ?></li>
					...
					<?php if (get_option('symposium_img_db') != "on") { ?>
						...
						<tr valign="top" style='border-top: 1px dashed #fff; border-right: 1px dashed #fff; border-left: 1px dashed #fff; '> 
						...
						<?php echo __('Image upload directory, eg:', 'wp-symposium').' '.WP_CONTENT_DIR.'/wps-content'; ?>
						...
						<tr valign="top" style='border-right: 1px dashed #fff; border-left: 1px dashed #fff; '> 
						...
						<span class="description"><?php echo __('URL to the images directory, Do not include http:// or your domain name eg: ', 'wp-symposium').' <a href="'.$url.'">'.$url.'</a>'; ?>
						...
						<tr valign="top" style='border-right: 1px dashed #fff; border-bottom: 1px dashed #fff; border-left: 1px dashed #fff; '> 
						<td colspan=2>
...
?>					
					...
					<span class="description"><?php echo sprintf(__('Width of all %s plugins, eg: 600px or 100%%', 'wp-symposium'), WPS_WL); ?></span></td> 
					</tr> 
					...
					<span class="description"><?php echo sprintf(__('Alignment of all %s plugins', 'wp-symposium'), WPS_WL); ?></span></td> 
					</tr> 		
					...
					<tr valign="top"> 
					<td scope="row"><label for="always_load"><?php echo __('Load WPS on every page', 'wp-symposium'); ?></label></td>
					<td>
					<input type="checkbox" name="always_load" id="always_load" <?php if (get_option('symposium_always_load') == "on") { echo "CHECKED"; } ?>/>
					<span class="description"><?php echo sprintf(__("Will always load %s components, or attempt a check if required.", 'wp-symposium'), WPS_WL); ?></span></td> 
					</tr>

					<tr valign="top"> 
					<td scope="row"><label for="long_menu"><?php echo __('Admin Tabs', 'wp-symposium'); ?></label></td>
					<td>
					<input type="checkbox" name="long_menu" id="symposium_long_menu" <?php if (get_option('symposium_long_menu') == "on") { echo "CHECKED"; } ?>/>
					<span class="description"><?php echo sprintf(__("Reduce %s admin menu items and show as tabs.", 'wp-symposium'), WPS_WL); ?></span></td> 
					</tr>
					...
					<span class="description"><?php echo sprintf(__("Only for use by %s developers.", 'wp-symposium'), WPS_WL); ?></span></td> 
					</tr>
...
function symposium_plugin_forum() {
	...
	symposium_show_tabs_header('forum');
	...
	global $wpdb;
		...
		if( isset($_POST[ 'symposium_update' ]) && $_POST[ 'symposium_update' ] == 'symposium_plugin_forum' ) {
			...
			update_option('symposium_use_wysiwyg_1', (isset($_POST[ 'use_wysiwyg_1' ]) && $_POST[ 'use_wysiwyg_1' ] != '') ? $_POST[ 'use_wysiwyg_1' ] : 'bold,italic,|,fontselect,fontsizeselect,forecolor,backcolor,|,bullist,numlist,|,link,unlink,|,image,media,|,emotions');
			...
			update_option('symposium_forum_reply_comment', serialize($level));	
		...
		echo '<a href="admin.php?page=symposium_categories">'.__('Go to Forum Management', 'wp-symposium').'</a><br /><br />';	 
		...
		?>
			...
			<tr><td colspan="2"><h2>Editor</h2></td></tr>
			...
			<?php if ( symposium_is_plus() ) { ?>
				...
				<?php if (get_option('symposium_use_wysiwyg') == 'on') { ?>					
					<tr valign="top" style='border-right: 1px dashed #fff; border-left: 1px dashed #fff; border-top: 1px dashed #fff;'> 
					...
					<tr valign="top" style='border-right: 1px dashed #fff; border-left: 1px dashed #fff; border-bottom: 1px dashed #fff;'> 
			...
			<tr valign="top"> 
			<td scope="row"><label for="forum_comments"><?php echo __('Forum comment roles', 'wp-symposium'); ?></label></td> 
			<td>
			<?php		
				// Get list of roles
				global $wp_roles;
				...
				$reply_roles = get_option('symposium_forum_reply_comment');
			...
			?>
			<span class="description"><?php echo __('The WordPress roles that can add comments to forum replies', 'wp-symposium'); ?></span></td> 
			</tr> 
			
			<tr><td colspan="2"><h2>More...</h2></td></tr>
...
function symposium_plugin_categories() {
	...
	if (isset($_POST['title'])) {
  	...
  	echo '<div id="icon-themes" class="icon32"><br /></div>';
  	echo '<h2>'.sprintf(__('%s Management', 'wp-symposium'), WPS_WL).'</h2><br />';
	symposium_show_manage_tabs_header('categories');
	echo '<a href="admin.php?page=symposium_forum">'.__('Go to Forum Options', 'wp-symposium').'</a><br /><br />';	 
	?> 
	<form method="post" action=""> 
...
function symposium_plugin_styles() {
	...
	if (!current_user_can('manage_options'))  {
  	...
  	echo '<div class="wrap">';
		...
		// Start tabs
		include_once('symposium_show_tabs_style.php');
		...
		echo '<div class="symposium-wrapper" style="margin-top:15px">';
			...
			echo '<div id="mail-main">';
				...
				if ($view == "css") {
					...
					echo '</td></tr>';
					echo '<tr><td>';
					echo sprintf(__('CSS will over-ride the %s Styles (other tab), but your theme may take priority.', 'wp-symposium'), WPS_WL);
					echo '</td></tr>';
					echo '<tr><td>';
...
function symposium_mail_messages_menu() {
	...
	if (isset($_GET['mail_mid_del'])) {
  	...
  	echo '<div class="wrap">';
	  	...
	  	echo '<div id="icon-themes" class="icon32"><br /></div>';
	  	echo '<h2>'.sprintf(__('%s Management', 'wp-symposium'), WPS_WL).'</h2><br />';
		symposium_show_manage_tabs_header('messages');
...
function symposium_mail_menu() {
	...
	$mail_all = get_option('symposium_mail_all');
  	...
  	echo '<div class="wrap">';
		...
		symposium_show_tabs_header('mail');
		?>
...
function symposium_members_menu() {
	...
	$dir_page_length = get_option('symposium_dir_page_length');
  	...
  	echo '<div class="wrap">';
		...
		symposium_show_tabs_header('directory');
		?>
...
function symposium_show_tabs_header($active_tab) {
	...
	if (get_option('symposium_long_menu') == "on") {
		...
		echo '<div id="mail_tabs">';
		echo '<div class="mail_tab nav-tab-'.$options_active.'"><a href="admin.php?page=symposium_options" class="nav-tab-'.$options_active.'-link">'.__('Options', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_profile')) 		echo '<div class="mail_tab nav-tab-'.$profile_active.'"><a href="admin.php?page=symposium_profile" class="nav-tab-'.$profile_active.'-link">'.__('Profile', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_profile_plus')) 	echo '<div class="mail_tab nav-tab-'.$plus_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_plus_admin.php" class="nav-tab-'.$plus_active.'-link">'.__('Plus', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_forum')) 		echo '<div class="mail_tab nav-tab-'.$forum_active.'"><a href="admin.php?page=symposium_forum" class="nav-tab-'.$forum_active.'-link">'.__('Forum', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_members')) 		echo '<div class="mail_tab nav-tab-'.$directory_active.'"><a href="admin.php?page=symposium_members_menu" class="nav-tab-'.$directory_active.'-link">'.__('Directory', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_mail')) 			echo '<div class="mail_tab nav-tab-'.$mail_active.'"><a href="admin.php?page=symposium_mail_menu" class="nav-tab-'.$mail_active.'-link">'.__('Mail', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_group')) 		echo '<div class="mail_tab nav-tab-'.$groups_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_groups_admin.php" class="nav-tab-'.$groups_active.'-link">'.__('Groups', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_gallery')) 		echo '<div class="mail_tab nav-tab-'.$gallery_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_gallery_admin.php" class="nav-tab-'.$gallery_active.'-link">'.__('Gallery', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_news_main')) 	echo '<div class="mail_tab nav-tab-'.$alerts_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_news_admin.php" class="nav-tab-'.$alerts_active.'-link">'.__('Alerts', 'wp-symposium').'</a></div>';
		if (function_exists('add_notification_bar')) 	echo '<div class="mail_tab nav-tab-'.$bar_active.'"><a href="admin.php?page=symposium_bar" class="nav-tab-'.$bar_active.'-link">'.__('Panel', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_events_main')) 	echo '<div class="mail_tab nav-tab-'.$events_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_events_admin.php" class="nav-tab-'.$events_active.'-link">'.__('Events', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_facebook')) 		echo '<div class="mail_tab nav-tab-'.$facebook_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_facebook_admin.php" class="nav-tab-'.$facebook_active.'-link">'.__('Facebook', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_mobile')) 		echo '<div class="mail_tab nav-tab-'.$mobile_active.'"><a href="admin.php?page=symposium_mobile_menu" class="nav-tab-'.$mobile_active.'-link">'.__('Mobile', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_mailinglist')) 	echo '<div class="mail_tab nav-tab-'.$replybyemail_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_mailinglist_admin.php" class="nav-tab-'.$replybyemail_active.'-link">'.__('Reply', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_lounge_main')) 	echo '<div class="mail_tab nav-tab-'.$lounge_active.' bronze"><a href="admin.php?page=wp-symposium/symposium_lounge_admin.php" class="nav-tab-'.$lounge_active.'-link">'.__('Lounge', 'wp-symposium').'</a></div>';
		echo '</div>';
...
function symposium_show_tabs_header_end() {
...
function symposium_show_manage_tabs_header($active_tab) {
	...
	if (get_option('symposium_long_menu') == "on") {
		...
		echo '<div id="mail_tabs">';
		echo '<div class="mail_tab nav-tab-'.$manage_active.'"><a href="admin.php?page=symposium_manage" class="nav-tab-'.$manage_active.'-link">'.__('Manage', 'wp-symposium').'</a></div>';
		echo '<div class="mail_tab nav-tab-'.$settings_active.'"><a href="admin.php?page=symposium_settings" class="nav-tab-'.$settings_active.'-link">'.__('Settings', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_forum')) echo '<div class="mail_tab nav-tab-'.$categories_active.'"><a href="admin.php?page=symposium_categories" class="nav-tab-'.$categories_active.'-link">'.__('Forum Categories', 'wp-symposium').'</a></div>';
		if (function_exists('symposium_forum')) echo '<div class="mail_tab nav-tab-'.$posts_active.'"><a href="admin.php?page=symposium_moderation" class="nav-tab-'.$posts_active.'-link">'.sprintf(__('Forum Posts%s', 'wp-symposium'), $count2).'</a></div>';
		if (function_exists('symposium_mail')) echo '<div class="mail_tab nav-tab-'.$messages_active.'"><a href="admin.php?page=symposium_mail_messages_menu" class="nav-tab-'.$messages_active.'-link">'.__('Mail Messages', 'wp-symposium').'</a></div>';
		echo '<div class="mail_tab nav-tab-'.$templates_active.'"><a href="admin.php?page=symposium_templates" class="nav-tab-'.$templates_active.'-link">'.__('Templates', 'wp-symposium').'</a></div>';
		echo '</div>';
...
function symposium_show_manage_tabs_header_end() {
