...
*/
		...
		if (current_user_can('update_core')) {
			...
			echo "<div style='width:50%; float:left; padding-bottom:15px;'>";
				...
				echo '<a name="perma"></a>';
			  	echo '<div id="icon-themes" class="icon32"><br /></div>';
			   	echo '<h2>'.__('WPS Permalinks', 'wp-symposium').' (BETA)</h2>';
			   	echo '<p style="font-weight:bold">'.__('This is work in progress, not complete, and not recommended for live sites!<br />Backup your website and database before enabling!', 'wp-symposium').'</p>';
					...
					echo '<form method="post" action="#perma">';
						...
						if ( get_option('symposium_permalink_structure')  ) {
							...
							if (!$reset) {
									...
									if ($symposium_rewrite_forum_single = $_POST['symposium_rewrite_forum_single'] ? $_POST['symposium_rewrite_forum_single'] : '') update_option('symposium_rewrite_forum_single', $symposium_rewrite_forum_single);
									if ($symposium_rewrite_forum_single_target = $_POST['symposium_rewrite_forum_single_target'] ? $_POST['symposium_rewrite_forum_single_target'] : '') update_option('symposium_rewrite_forum_single_target', $symposium_rewrite_forum_single_target);
									if ($symposium_rewrite_forum_double = $_POST['symposium_rewrite_forum_double'] ? $_POST['symposium_rewrite_forum_double'] : '') update_option('symposium_rewrite_forum_double', $symposium_rewrite_forum_double);
									if ($symposium_rewrite_forum_double_target = $_POST['symposium_rewrite_forum_double_target'] ? $_POST['symposium_rewrite_forum_double_target'] : '') update_option('symposium_rewrite_forum_double_target', $symposium_rewrite_forum_double_target);
									if ($symposium_rewrite_members = $_POST['symposium_rewrite_members'] ? $_POST['symposium_rewrite_members'] : '') update_option('symposium_rewrite_members', $symposium_rewrite_members);
									if ($symposium_rewrite_members_target = $_POST['symposium_rewrite_members_target'] ? $_POST['symposium_rewrite_members_target'] : '') update_option('symposium_rewrite_members_target', $symposium_rewrite_members_target);
