  	...
  	echo '<div class="wrap">';
		...
		echo '<div class="symposium-wrapper" style="margin-top:15px">';
			...
			if (function_exists('symposium_facebook')) {
				echo '<div class="mail_tab nav-tab-'.$facebook_active.'"><a href="admin.php?page=symposium_options&view=facebook" class="nav-tab-'.$facebook_active.'-link">'.__('Facebook', 'wp-symposium').'&trade;</a></div>';
			}
			echo '</div>';
