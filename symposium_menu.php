 	...
 	$wpdb->show_errors();
  	...
  	echo '<div class="wrap">';
		...
		if (isset($_POST['symposium_validation_code'])) {
	   	...
	   	echo __('Activation Code:', 'wp-symposium').' <input type="text" name="symposium_validation_code" value="'.get_option('symposium_activation_code').'" style="width:300px" class="regular-text">';
		...
		// Status
		echo '<div id="icon-themes" class="icon32"><br /></div>';
		echo '<h2>' . __('Plugin Status', 'wp-symposium') . '</h2>';
