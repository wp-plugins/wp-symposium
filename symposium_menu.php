		...
		if ($posts) {
			...
			foreach ($posts as $post) {
				...
				if ($post->topic_approved != "on") {
					echo '<img src="'.WP_CONTENT_URL.'/plugins/wp-symposium/images/forum_orange.png" alt="Unapproved" />';
				} else {
					echo '<img src="'.WP_CONTENT_URL.'/plugins/wp-symposium/images/forum_green.png" alt="Unapproved" />';
				}
				echo '</td>';
				echo '<td valign="top">';
				if ($post->topic_parent == 0) {
 	...
 	$wpdb->show_errors();
  	...
  	echo '<div class="wrap">';
		...
		echo "<div style='margin-top:15px'>";
			...
			echo '<th width="90px;">'.__('Status', 'wp-symposium').' [<a href="javascript:void(0);" id="symposium_url">?</a>]</th>';
		...
		echo "<div style='width:45%; float:left'>";
			...
			echo '<iframe id="symposium_versions" onload="document.getElementById(\'symposium_versions_waiting\').style.display=\'none\'; document.getElementById(\'symposium_versions\').style.display=\'block\';" style="display: none; height: 320px; width:100%;" src="'.$ver_goto.'"></iframe>';
	...
	global $wpdb;
		...
		$config = $wpdb->get_row($wpdb->prepare("SELECT * FROM ".$wpdb->prefix.'symposium_config'));					
				...
				echo '<div class="metabox-holder"><div id="toc" class="postbox">';
					...
					<tr valign="top"> 
					<th scope="row"><label for="redirect_wp_profile"><?php _e('Redirect profile page', 'wp-symposium'); ?></label></th>
					<td>
					...
					<tr valign="top"> 
					<th scope="row"><label for="menu_profile"><?php _e('Profile Menu Items', 'wp-symposium'); ?></label></th>
					<td>
					...
					<tr valign="top"> 
					<th scope="row"><label for="menu_texthtml"><?php _e('Profile Menu Text/HTML', 'wp-symposium'); ?></label></th>
					<td>
	...
	global $wpdb;
		...
		$config = $wpdb->get_row($wpdb->prepare("SELECT * FROM ".$wpdb->prefix.'symposium_config'));
				...
				echo '<div class="metabox-holder"><div id="toc" class="postbox">';
					...
					<tr valign="top"> 
					<th scope="row"><label for="img_db">Store uploads in database</label></th>
					<td>
					...
					<tr valign="top"> 
					<th scope="row"><label for="image_ext">Image extensions</label></th> 
					...
					<?php if ($img_db != "on") { ?>
						...
						<tr valign="top"> 
						<th scope="row"><label for="video_ext">Video extensions</label></th> 
						...
						<tr valign="top"> 
						<th scope="row"><label for="doc_ext">Document extensions</label></th> 
					...
					<tr valign="top"> 
					<th scope="row"><label for="striptags">Strip tags</label></th>
					<td>
					...
					<tr valign="top"> 
					<th scope="row"><label for="elastic">Elastic Textboxes</label></th>
					<td>
...
// yyy
		...
		<div class="metabox-holder"><div id="toc" class="postbox"> 
			...
			<tr valign="top"> 
			<th scope="row"><label for="forum_uploads"><?php _e('Allow uploads', 'wp-symposium'); ?></label></th>
			<td>
			<input type="checkbox" name="forum_uploads" id="forum_uploads" <?php if ($forum_uploads == "on") { echo "CHECKED"; } ?>/>
			<span class="description"><?php echo __('Allow members to upload files with forum posts', 'wp-symposium'); ?></span></td> 
			</tr> 
	
			<tr valign="top"> 
			<th scope="row"><label for="forum_info"><?php _e('Member Info', 'wp-symposium'); ?></label></th>
			<td>
			...
			<tr valign="top"> 
			<th scope="row"><label for="forum_thumbs"><?php _e('Inline attachments', 'wp-symposium'); ?></label></th>
			<td>
			...
			<tr valign="top"> 
			<th scope="row"><label for="forum_thumbs_size"><?php _e('Thumbnail size', 'wp-symposium'); ?></label></th>
			...
			<tr valign="top"> 
			<th scope="row"><label for="use_votes_min"><?php _e('Votes (minimum posts)', 'wp-symposium'); ?></label></th>
			...
			<tr valign="top"> 
			<th scope="row"><label for="use_answers"><?php _e('Votes (answers)', 'wp-symposium'); ?></label></th>
			<td>
			...
			<tr valign="top"> 
			<th scope="row"><label for="chatroom_banned">Banned forum words</label></th> 
			<td><input name="chatroom_banned" type="text" id="chatroom_banned"  value="<?php echo $chatroom_banned; ?>" /> 
			...
			<tr valign="top"> 
			<th scope="row"><label for="symposium_forumlatestposts_count"><?php _e('[symposium-forumlatestposts]', 'wp-symposium'); ?></label></th>
  	...
  	echo '<h2>'.__('Release Notes', 'wp-symposium').'</h2><br />';
		...
		global $wpdb;
					...
					<div class="postbox-container side" style="width:34%; float:right"> 
						<div class="metabox-holder">	
							...
							<div id="toc" class="postbox"> 
								<h3>WPS Plugin versions</h3> 
								<div class="inside"> 
									<div id="symposium_version_waiting">
									<?php 
									$ver_goto = "http://www.wpsymposium.com/wp-content/symposium_versions.php";
									echo "<img src='".WP_PLUGIN_URL."/wp-symposium/images/busy.gif' />"; 
									?>
									</div>
									<iframe id="symposium_version_rn" onload="symposium_version()" style="display: none; height: 637px; width:100%;" src="<?php echo $ver_goto; ?>"></iframe>
								</div> 
							</div>
				...
				<script type="text/javascript">
					...
					function symposium_version()
					{
						document.getElementById('symposium_version_waiting').style.display='none';
						document.getElementById('symposium_version_rn').style.display='block';
					} 								
				</script>
				<?php
	echo '</div>';
			...
			echo '<div id="mail-main">';
				...
				if ($view == "styles") {
					...
					if ($style) {
						...
						<tr valign="top"> 
						<th scope="row"><label for="categories_background">Miscellaneous</label></th> 
	...
	$mail_all = $config->mail_all;
  	...
  	echo '<div class="wrap">';
		...
		<div class="metabox-holder"><div id="toc" class="postbox"> 
			...
			<tr valign="top"> 
			<th scope="row"><label for="mail_all"><?php _e('Mail to all', 'wp-symposium'); ?></label></th>
			<td>
