...
function symposium_plugin_welcome() {
			...
			<div id="wps-welcome-panel" class="welcome-panel" style="margin-top:40px">
			    ...
			    echo ' '.sprintf(__('For more information and release notes, check out the <a href="%s" target="_blank">WP Symposium blog</a>.', 'wp-symposium'), 'http://www.wpsymposium.com/2012/07/release-notes-for-v'.$ver);
				...
				<div class="welcome-panel-column-container">
					<div class="welcome-panel-column">
						...
						<p><?php echo sprintf(__( 'What\'s new in this release? For more detail and release notes, head on over to the <a href="%s" target="_blank">WP Symposium blog</a>.', 'wp-symposium' ), "http://www.wpsymposium.com/blog"); ?></p>
						<ul>
						<li><?php echo sprintf(	__( '<a href="%s">Set which profile menu items appear</a>' ), esc_url( admin_url('admin.php?page=symposium_profile') ) ); ?></li>
						<li><?php echo sprintf(	__( '<a href="%s">Change the text of profile menu items</a>' ), esc_url( admin_url('admin.php?page=symposium_profile') ) ); ?></li>
						<li><?php _e('Option to move profile menu down as page scrolls', 'wp-symposium'); ?></li>
						<li><?php _e('Gallery photos now managed through dialog box viewer', 'wp-symposium'); ?></li>
						<li><?php _e('Drag and drop thumbnails to re-order your gallery photos', 'wp-symposium'); ?></li>
						<li><?php _e('Rename gallery photo as you look at it', 'wp-symposium'); ?></li>
						<li><?php _e('Set current photo in gallery to album cover image', 'wp-symposium'); ?></li>
						<li><?php _e('Manage button removed from Gallery page (not needed)', 'wp-symposium'); ?></li>
						<li><?php _e('Where possible, WPS will not load unnecessary scripts', 'wp-symposium'); ?></li>
						</ul>
					</div>
					<div class="welcome-panel-column">
...
?>					
					...
					<span class="description"><?php echo __("Will always load WP Symposium components, or attempt a check if required.", 'wp-symposium'); ?></span></td> 
					</tr>
