...
function symposium_notification_do_jobs($mode) {
	...
	if ($send_summary == "on" || $mode != 'cron') {
		...
		if ($topics_count > 0) {
			...
			// Get Forum URL
			$forum_url = get_bloginfo('wpurl').$wpdb->get_var($wpdb->prepare("SELECT forum_url FROM ".$wpdb->prefix . 'symposium_config'));
...
function add_symposium_stylesheet() {
	...
	echo "<strong>".__("Favourites", "wp-symposium")."</strong><div id='favs_close' style='float:right;cursor:pointer;width:18px; text-align:center'><img src='".WP_PLUGIN_URL."/wp-symposium/images/close.png' alt='".__("Close", "wp-symposium")."' /></div>";	
	...
	echo "<strong>".__("Forum Activity", "wp-symposium")."</strong><div id='activity_close' style='float:right;cursor:pointer;width:18px; text-align:center'><img src='".WP_PLUGIN_URL."/wp-symposium/images/close.png' alt='".__("Close", "wp-symposium")."' /></div>";	
	...
	echo "<strong>".__("Search", "wp-symposium")."</strong><div id='search_close' style='float:right;cursor:pointer;width:18px; text-align:center'><img src='".WP_PLUGIN_URL."/wp-symposium/images/close.png' alt='".__("Close", "wp-symposium")."' /></div>";	
