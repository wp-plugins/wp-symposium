...
// Define WPS titles
if (!defined(WPS_WL)) define('WPS_WL', 'WP Symposium');
if (!defined(WPS_WL_SHORT)) define('WPS_WL_SHORT', 'Symposium');
...
add_action('wp_footer', 'symposium_concealed_avatar', 10);
add_action('template_redirect', 'symposium_replace');
add_action('wp_print_styles', 'add_symposium_stylesheet');

// Following required whether WPS features on the page or not
...
if (is_admin()) {
	...
	add_filter('admin_footer_text', 'symposium_footer_admin');
...
if ( ( get_option("symposium_version") != WPS_VER && is_admin()) || (isset($_GET['force_create_wps']) && $_GET['force_create_wps'] == 'yes' && is_admin())) {
	...
	if (!$wpdb->get_var($wpdb->prepare("SELECT option_name FROM ".$wpdb->prefix."options WHERE option_name = 'symposium_categories_background'"))) {
		...
		update_option('symposium_forum_url', __('Important: Please visit Installation page!', "wp-symposium"));	 			  
		...
		update_option('symposium_mail_url', __('Important: Please visit Installation page!', "wp-symposium"));
		...
		update_option('symposium_members_url', __('Important: Please visit Installation page!', "wp-symposium"));
		...
		update_option('symposium_profile_url', __('Important: Please visit Installation page!', "wp-symposium"));
		update_option('symposium_groups_url', __('Important: Please visit Installation page!', "wp-symposium"));
		update_option('symposium_group_url', __('Important: Please visit Installation page!', "wp-symposium"));
		...
		update_option('symposium_menu_profile_other', 'on');
		update_option('symposium_menu_my_activity_other', 'on');
		update_option('symposium_menu_friends_activity_other', 'on');
		update_option('symposium_menu_all_activity_other', 'on');
		update_option('symposium_menu_friends_other', 'on');		
	...
	if (!get_option('symposium_long_menu')) update_option('symposium_long_menu', 'on');
	
	// Profile menu text
	if (!get_option('symposium_menu_profile_text')) update_option('symposium_menu_profile_text', __('My Profile', 'wp-symposium'));
	if (!get_option('symposium_menu_my_activity_text')) update_option('symposium_menu_my_activity_text', __('My Activity', 'wp-symposium'));
	if (!get_option('symposium_menu_friends_activity_text')) update_option('symposium_menu_friends_activity_text', __('Friends Activity', 'wp-symposium'));
	if (!get_option('symposium_menu_all_activity_text')) update_option('symposium_menu_all_activity_text', __('All Activity', 'wp-symposium'));
	if (!get_option('symposium_menu_friends_text')) update_option('symposium_menu_friends_text', __('My Friends', 'wp-symposium'));
	if (!get_option('symposium_menu_mentions_text')) update_option('symposium_menu_mentions_text', __('Forum @mentions', 'wp-symposium'));
	if (!get_option('symposium_menu_groups_text')) update_option('symposium_menu_groups_text', __('My Groups', 'wp-symposium'));
	if (!get_option('symposium_menu_events_text')) update_option('symposium_menu_events_text', __('My Events', 'wp-symposium'));
	if (!get_option('symposium_menu_gallery_text')) update_option('symposium_menu_gallery_text', __('My Gallery', 'wp-symposium'));
	if (!get_option('symposium_menu_following_text')) update_option('symposium_menu_following_text', __('I am Following', 'wp-symposium'));
	if (!get_option('symposium_menu_followers_text')) update_option('symposium_menu_followers_text', __('My Followers', 'wp-symposium'));
	if (!get_option('symposium_menu_lounge_text')) update_option('symposium_menu_lounge_text', __('The Lounge', 'wp-symposium'));
	if (!get_option('symposium_menu_avatar_text')) update_option('symposium_menu_avatar_text', __('Profile Photo', 'wp-symposium'));
	if (!get_option('symposium_menu_details_text')) update_option('symposium_menu_details_text', __('Profile Details', 'wp-symposium'));
	if (!get_option('symposium_menu_settings_text')) update_option('symposium_menu_settings_text', __('Community Settings', 'wp-symposium'));
	if (!get_option('symposium_menu_profile_other_text')) update_option('symposium_menu_profile_other_text', __('Profile', 'wp-symposium'));
	if (!get_option('symposium_menu_my_activity_other_text')) update_option('symposium_menu_my_activity_other_text', __('Activity', 'wp-symposium'));
	if (!get_option('symposium_menu_friends_activity_other_text')) update_option('symposium_menu_friends_activity_other_text', __('Friends Activity', 'wp-symposium'));
	if (!get_option('symposium_menu_all_activity_other_text')) update_option('symposium_menu_all_activity_other_text', __('All Activity', 'wp-symposium'));
	if (!get_option('symposium_menu_friends_other_text')) update_option('symposium_menu_friends_other_text', __('Friends', 'wp-symposium'));
	if (!get_option('symposium_menu_mentions_other_text')) update_option('symposium_menu_mentions_other_text', __('Forum @mentions', 'wp-symposium'));
	if (!get_option('symposium_menu_groups_other_text')) update_option('symposium_menu_groups_other_text', __('Groups', 'wp-symposium'));
	if (!get_option('symposium_menu_events_other_text')) update_option('symposium_menu_events_other_text', __('Events', 'wp-symposium'));
	if (!get_option('symposium_menu_gallery_other_text')) update_option('symposium_menu_gallery_other_text', __('Gallery', 'wp-symposium'));
	if (!get_option('symposium_menu_following_other_text')) update_option('symposium_menu_following_other_text', __('Following', 'wp-symposium'));
	if (!get_option('symposium_menu_followers_other_text')) update_option('symposium_menu_followers_other_text', __('Followers', 'wp-symposium'));
	if (!get_option('symposium_menu_lounge_other_text')) update_option('symposium_menu_lounge_other_text', __('The Lounge', 'wp-symposium'));
	...
	symposium_alter_table("gallery_items", "ADD", "photo_order", "int(11)", "NOT NULL", "'0'");
...
function symposium_required() {
	
	// Using panel?
	if (function_exists('add_notification_bar'))
		return true;

	// Page/post contains WPS shortcode?
	global $post;
	$content = $post->post_content;	
	if (strpos($content, '[symposium-') !== FALSE)
		return true;
	
	if (get_option('symposium_always_load')) {
		return true;
	} else {
		return false;
	}
...
function symposium_dashboard_widget(){
	wp_add_dashboard_widget('symposium_id', WPS_WL, 'symposium_widget');
}
...
function symposium_notification_more_reccurences($recc) {
	$recc['symposium_notification_recc'] = array('interval' => get_option("symposium_notification_inseconds"), 'display' => WPS_WL_SHORT.' Notification Schedule');
	return $recc;
}
...
function symposium_notification_do_jobs($mode) {
	...
	$summary_email .= sprintf(__("%s version", "wp-symposium"), WPS_WL).": ".WPS_VER."<br />";
...
function symposium_concealed_avatar() {
	if (symposium_required()) {
		global $current_user;
...
function symposium_footer_admin () {
...
function symposium_scriptsAction() {
	...
	if (!is_admin()) {
		...
		wp_localize_script( 'symposium', 'symposium', array(
			...
			'profile_menu_scrolls' => get_option('symposium_profile_menu_scrolls'),
			'profile_menu_delta' => get_option('symposium_profile_menu_delta'),
			'profile_menu_adjust' => get_option('symposium_profile_menu_adjust')
		));
...
function add_symposium_stylesheet() {
	...
	if (!is_admin() && symposium_required()) {
