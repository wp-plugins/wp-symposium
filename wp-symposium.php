...
function symposium_scriptsAction() {
	...
	// Set admin page, depending on level
	if ( (current_user_can('manage_network') && wps_is_wpmu()) || (current_user_can('edit_theme_options') && !wps_is_wpmu()) ) {
		define('WPS_ADMIN_PAGE', 'symposium_debug');
	} else {
		define('WPS_ADMIN_PAGE', 'symposium_wpmu_debug');
	}
