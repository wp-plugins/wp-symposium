...
function symposium_uninstall() {
   	...
   	$wpdb->query("DROP TABLE IF EXISTS ".$wpdb->base_prefix."symposium_mail");
   	$wpdb->query("DROP TABLE IF EXISTS ".$wpdb->prefix."symposium_chat");
   	$wpdb->query("DROP TABLE IF EXISTS ".$wpdb->base_prefix."symposium_comments");
