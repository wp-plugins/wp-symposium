...
jQuery(document).ready(function() {
	...
	jQuery("#reset_profile_header").click(function() {
		if (confirm(areyousure)) {
			var reset = "<div style='float:right'>[poke]</div>[]<div style='float:right'>[follow]</div>[]<div id='profile_name'>[display_name]</div>[]<div id='profile_header_div'>[]<div id='profile_label'>[profile_label]</div>[]<div id='profile_header_panel'>[]<div id='profile_photo' class='corners'>[avatar,200]</div>[]<div id='profile_details'>[]<p>[location]<br />[born]</p>[]<div id='profile_actions_div'>[actions]</div>[]</div>[]</div>[]</div>";
	...
	jQuery("#reset_page_footer").click(function() {
		if (confirm(areyousure)) {
			var reset = "<div id='powered_by_wps'>[]<a href='http://www.wp__wps__.com' target='_blank'>[powered_by_message] v[version]</a>[]</div>";
			reset = reset.replace(/\[\]/g, String.fromCharCode(13));
	...
	jQuery("#reset_email").click(function() {
		if (confirm(areyousure)) {
			var reset = "<style> body { background-color: #eee; } </style>[]<div style='margin: 20px; padding:20px; border-radius:10px; background-color: #fff;border:1px solid #000;'>[][message][]<br /><hr />[][footer]<br />[]<a href='http://www.wp__wps__.com' target='_blank'>[powered_by_message] v[version]</a>[]</div>";
			reset = reset.replace(/\[\]/g, String.fromCharCode(13));
	...
	jQuery("#reset_template_forum_topic").click(function() {
		if (confirm(areyousure)) {
			var reset = "<div class='row_startedby'>[]<div class='first_topic'>[]<div class='avatar avatar_first_topic'>[avatarfirst,32]</div>[]<div class='first_topic_text'>[startedby][started]</div>[]</div><div class='last_reply'>[]<div class='avatar avatar_last_topic'>[avatar,32]</div>[]<div class='last_topic_text'>[replied][topic][ago]</div>[]</div>[]</div>[]<div class='row_views'>[views]</div>[]<div class='row_replies'>[replies]</div>[]<div class='row_topic'>[topic_title]</div>";
			reset = reset.replace(/\[\]/g, String.fromCharCode(13));
