jQuery(document).ready(function() { 	
	...
	*/
	...
	jQuery("#share_permalink").live('click', function() {
		var str = '<br />Copy and Paste the following:';
		str += '<br /><input type="text" style="width:260px;" value="'+jQuery(this).attr("title")+'" />';
		jQuery("#dialog").html(str);
		jQuery("#dialog").dialog({ title: 'Forum Permalink' });
	});
