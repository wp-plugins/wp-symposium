jQuery(document).ready(function() { 	
	...
	*/
	...
	jQuery(".symposium_profile_menu").click(function(){
		...
		jQuery('#profile_menu div').removeClass('symposium_profile_current');
		...
		if ( (menu_id == 'menu_extended') || 
			...
			if (strpos(ajax_part, '->') !== false) {
	            ...
	            var ajax_path = symposium.plugin_pro_url+ajax_sub+"/ajax/symposium_"+ajax_sub+"_functions.php";
