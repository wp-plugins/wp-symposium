...
*/
	...
	if ($styles) {
		...
		if ($styles->use_styles == "on") {
			...
			echo ".symposium-wrapper, .symposium-wrapper input[type=text], .symposium-wrapper input[type=password], .symposium-wrapper textarea, .popup, #mail_recipient_list, .mail_recipient_list_option {".PHP_EOL;
			...
			echo ".symposium-wrapper, #mail_recipient_list, .mail_recipient_list_option {".PHP_EOL;
			...
			echo ".symposium-wrapper #profile_right_column, .popup {".PHP_EOL;
			echo "	background-color: ".$main_background." !important;".PHP_EOL;
			...
			echo ".symposium-wrapper .new-topic-subject-input, .symposium-wrapper .input-field, .symposium-wrapper #mail_recipient_list {".PHP_EOL;
			echo "	font-family: ".$fontfamily.";".PHP_EOL;
