		...
		if ($styles) {
			...
			$html .= "<style>";
				...
				if ($styles->use_styles == "on") {
					...
					$html .= "body img, body input, .corners {";
					$html .= "	border-radius: ".$border_radius."px !important;";
					$html .= "	-moz-border-radius: ".$border_radius."px !important;";
					$html .= "}";
					...
					$html .= "  -moz-border-radius-topright:".($border_radius-5)."px;";
					$html .= "}";
