...
*/
	...
	if ($styles) {
		...
		if ($styles->use_styles == "on") {
			...
			$style .= ".symposium-wrapper, .symposium-wrapper input[type=text], .symposium-wrapper input[type=password], .symposium-wrapper textarea, .popup, #mail_recipient_list, .mail_recipient_list_option {".PHP_EOL;
			...
			$style .= ".symposium-wrapper .sep {".PHP_EOL;
			$style .= "	clear:both;".PHP_EOL;
			$style .= "	width:100%;".PHP_EOL;
			$style .= "	border-bottom: ".$row_border_size."px ".$row_border_style." ".$text_color_2.";".PHP_EOL;
			$style .= "}".PHP_EOL;
