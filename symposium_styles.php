...
*/
	...
	if (get_option('symposium_use_styles') == "on") {
		...
		$fontfamily = get_option('symposium_fontfamily');
		$fontsize = get_option('symposium_fontsize');
		$headingsfamily = get_option('symposium_headingsfamily');
		...
		$style .= "	color: ".$text_color.";".PHP_EOL;
		$style .= "}".PHP_EOL;
		$style .= "#profile_menu div, #profile_header_panel div, #profile_body_wrapper div {".PHP_EOL;
