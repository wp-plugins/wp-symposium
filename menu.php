	...
	global $wpdb;
		...
		<form method="post" action=""> 
			...
			if (!$readonly) { ?>
				...
				<tr valign="top"> 
				<td colspan="2"><?php echo '<h2>'.__('Troubleshooting', WPS_TEXT_DOMAIN).'</h2>'; echo __('The following can be disabled (or if clashes with other WordPress plugins are occuring)', WPS_TEXT_DOMAIN); ?>:</td>
				</tr> 
