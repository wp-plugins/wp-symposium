...
function __wps__plugin_menu() {
				...
				if ($fields) {
					foreach ($fields as $field) {
						...
						if ( $split[0] != '') {
							...
							$extension = $wpdb->get_row($wpdb->prepare("SELECT extended_name,extended_type FROM ".$wpdb->prefix."symposium_extended WHERE eid = %d", $split[0]));
	...
	if (!WPS_HIDE_PLUGINS) {
		...
		if (__wps__is_wpmu()) {
			...
			add_submenu_page('symposium_debug', __('Welcome/help', WPS_TEXT_DOMAIN), __('Welcome/help', WPS_TEXT_DOMAIN), 'manage_options', 'symposium_welcome', '__wps__plugin_welcome');
...
function __wps__plugin_welcome() {
	...
	if ($file = @file_get_contents(WPS_WELCOME_MESSAGE)) {
		...
		?>
		<div id="wps-welcome-panel" class="welcome-panel" style="margin: 30px 20px 0 0">
			<div id="motd" class="welcome-panel-content">
			    ...
			    echo '<br />'.sprintf(__('Please always read the <a href="%s" target="_blank">release notes</a> after upgrading %s.', WPS_TEXT_DOMAIN), 'http://www.wpsymposium.com/category/releases/', WPS_WL);
...
function __wps__plugin_templates() {
	...
	if ($_POST['symposium_template_update'] == 'on') {
		
		if (is_multisite() && $_POST['symposium_templates_network_update']) {
	...
	$template_group_forum_topic = str_replace("[]", chr(13), stripslashes(get_option(WPS_OPTIONS_PREFIX.'_template_group_forum_topic')));
  	...
  	echo '<div class="wrap">';
		...
		echo '<div id="symposium_templates_values">';
			...
			// Profile Page Header
			echo '<br /><br /><table class="widefat">';
			echo '<thead>';
			echo '<tr>';
			echo '<th style="font-size:1.2em">'.__('Profile Page Header', WPS_TEXT_DOMAIN).'</th>';
			echo '</tr>';
			echo '</thead>';
			echo '<tbody>';
			echo '<tr>';
			...
			echo '<thead>';
			echo '<tr>';
			echo '<th style="font-size:1.2em">'.__('Group Page', WPS_TEXT_DOMAIN).'</th>';
			echo '</tr>';
			echo '</thead>';
			echo '<tbody>';
			echo '<tr>';
			...
			echo '<thead>';
			echo '<tr>';
			echo '<th style="font-size:1.2em">'.__('Group Forum Categories (list)', WPS_TEXT_DOMAIN).'</th>';
			echo '</tr>';
			echo '</thead>';
			echo '<tbody>';
			echo '<tr>';
	...
	wp_get_current_user();
 	...
 	$wpdb->show_errors();
  	...
  	echo '<div class="wrap">';
		...
		if ($_POST['__wps__installation_update'] == 'Y') {
			// Network activations
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__events_main_network_activated', $_POST['__wps__events_main_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__forum_network_activated', $_POST['__wps__forum_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__profile_network_activated', $_POST['__wps__profile_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__mail_network_activated', $_POST['__wps__mail_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__members_network_activated', $_POST['__wps__members_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__add_notification_bar_network_activated', $_POST['__wps__add_notification_bar_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__facebook_network_activated', $_POST['__wps__facebook_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__gallery_network_activated', $_POST['__wps__gallery_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__groups_network_activated', $_POST['__wps__groups_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__lounge_main_network_activated', $_POST['__wps__lounge_main_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__mobile_network_activated', $_POST['__wps__mobile_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__news_main_network_activated', $_POST['__wps__news_main_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__profile_plus_network_activated', $_POST['__wps__profile_plus_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__rss_main_network_activated', $_POST['__wps__rss_main_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__mailinglist_network_activated', $_POST['__wps__mailinglist_network_activated'], true);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__wysiwyg_network_activated', $_POST['__wps__wysiwyg_network_activated'], true);
			// Site specific
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__events_main_activated', $_POST['__wps__events_main_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__forum_activated', $_POST['__wps__forum_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__profile_activated', $_POST['__wps__profile_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__mail_activated', $_POST['__wps__mail_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__members_activated', $_POST['__wps__members_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__add_notification_bar_activated', $_POST['__wps__add_notification_bar_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__facebook_activated', $_POST['__wps__facebook_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__gallery_activated', $_POST['__wps__gallery_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__groups_activated', $_POST['__wps__groups_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__lounge_main_activated', $_POST['__wps__lounge_main_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__mobile_activated', $_POST['__wps__mobile_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__news_main_activated', $_POST['__wps__news_main_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__profile_plus_activated', $_POST['__wps__profile_plus_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__rss_main_activated', $_POST['__wps__rss_main_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__mailinglist_activated', $_POST['__wps__mailinglist_activated'], false);
			__wps__update_option(WPS_OPTIONS_PREFIX.'__wps__wysiwyg_activated', $_POST['__wps__wysiwyg_activated'], false);
		}

		if (isset($_POST['symposium_validation_code']))
			__wps__update_option(WPS_OPTIONS_PREFIX.'_activation_code', $_POST['symposium_validation_code'], true);
		...
		echo "<div style='margin-top:15px; margin-bottom:15px; '>";
			...
			__wps__install_row(__('Profile', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-profile', '__wps__profile', get_option(WPS_OPTIONS_PREFIX.'_profile_url'), WPS_DIR.'/profile.php', 'admin.php?page=profile', '__wps__<a href="admin.php?page=symposium_profile">Options</a>');
			__wps__install_row(__('Forum', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-forum', '__wps__forum', get_option(WPS_OPTIONS_PREFIX.'_forum_url'), WPS_DIR.'/forum.php', 'admin.php?page=forum', '__wps__<a href="admin.php?page=symposium_forum">Options</a>');
			__wps__install_row(__('Members', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-members', '__wps__members', get_option(WPS_OPTIONS_PREFIX.'_members_url'), WPS_DIR.'/members.php', 'admin.php?page=__wps__members_menu', '__wps__<a href="admin.php?page=__wps__members_menu">Options</a>');
			__wps__install_row(__('Mail', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-mail', '__wps__mail', get_option(WPS_OPTIONS_PREFIX.'_mail_url'), WPS_DIR.'/mail.php', '', '__wps__<a href="admin.php?page=__wps__mail_menu">Options</a>');
			__wps__install_row(__('Panel', WPS_TEXT_DOMAIN), '', '__wps__add_notification_bar', '-', WPS_DIR.'/panel.php', 'admin.php?page=bar', '__wps__<a href="admin.php?page=symposium_bar">Options</a>');
			...
			if ( is_super_admin() ) {
				...
				echo '<thead><tr>';
					echo '<th colspan='.$colspan.'>'.__('Bronze member features', WPS_TEXT_DOMAIN).'</th>';
				echo '</tr></thead>';
				...
				echo '<td colspan='.$colspan.'>';
					...
					if (!WPS_HIDE_ACTIVATION) {
						...
						if (!get_option(WPS_OPTIONS_PREFIX.'_activation_code')) {
							echo '<img style="float:right; margin:0 0 5px 10px;" src="'.WPS_PLUGIN_URL.'/images/bronze.png" />';
						} else {
							echo '<img style="width:70px; height:70px; float:right; margin:0 0 5px 10px;" src="'.WPS_PLUGIN_URL.'/images/bronze.png" />';
						}
						if (!get_option(WPS_OPTIONS_PREFIX.'_activation_code')) {
							
							echo '<p>';
								echo __('The following features are "Bronze" member features. You can use them for free, but a polite notice will be shown at the top of your web pages.', WPS_TEXT_DOMAIN).' ';
								echo __('<strong>If you have purchased Bronze membership at www.wpsymposium.com</strong>, your activation code is shown at <a href="http://www.wpsymposium.com/membership" target="_new">http://www.wpsymposium.com/membership</a> (make sure you&apos;ve logged in!).', WPS_TEXT_DOMAIN);
							echo '</p>';					
						}
						...
						echo '<input type="text" name="symposium_validation_code" value="'.get_option(WPS_OPTIONS_PREFIX.'_activation_code').'" style="height:24px;margin-top:-2px;width:300px; background-color: #ff9; border:1px solid #333;">';
						echo ' <input type="submit" class="button-primary" value="'.__('Save', WPS_TEXT_DOMAIN).'" />';
						if ($code=get_option(WPS_OPTIONS_PREFIX.'_activation_code')) {
							...
							echo '<br />(no activation code entered)';
						}
						echo '</p>';
					}
			...
			__wps__install_row(__('Forum WYSIWYG editor', WPS_TEXT_DOMAIN), '', '__wps__wysiwyg', '-', '', WPS_DIR.'/forum.php', '__wps__bronze__<a href="admin.php?page=symposium_forum">Options</a>');
			__wps__install_row(__('Profile_Plus', WPS_TEXT_DOMAIN), '', '__wps__profile_plus', '-', 'wp-symposium/plus.php', 'admin.php?page='.WPS_DIR.'/plus_admin.php', '__wps__bronze__<a href="admin.php?page=wp-symposium/plus_admin.php">Options</a>');
			__wps__install_row(__('Groups', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-groups', '__wps__groups', get_option(WPS_OPTIONS_PREFIX.'_groups_url'), WPS_DIR.'/groups.php', 'admin.php?page='.WPS_DIR.'/groups_admin.php', '__wps__bronze__<a href="admin.php?page=wp-symposium/groups_admin.php">Options</a>');
			__wps__install_row(__('Group', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-group', '__wps__group', get_option(WPS_OPTIONS_PREFIX.'_group_url'), WPS_DIR.'/groups.php', '', '__wps__bronze__');
			__wps__install_row(__('Gallery', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-galleries', '__wps__gallery', '/gallery/', WPS_DIR.'/gallery.php','admin.php?page='.WPS_DIR.'/gallery_admin.php', '__wps__bronze__<a href="admin.php?page=wp-symposium/gallery_admin.php">Options</a>');
			__wps__install_row(__('Alerts', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-alerts', '__wps__news_main', '-', WPS_DIR.'/news.php', 'admin.php?page='.WPS_DIR.'/news_admin.php', '__wps__bronze__<a href="admin.php?page=wp-symposium/news_admin.php">Options</a>');
			__wps__install_row(__('Events', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-events', '__wps__events_main', '-', WPS_DIR.'/events.php', 'admin.php?page='.WPS_DIR.'/events_admin.php', '__wps__bronze__<a href="admin.php?page=wp-symposium/events_admin.php">Options</a>');
			__wps__install_row(__('Mobile', WPS_TEXT_DOMAIN), '', '__wps__mobile', '-', WPS_DIR.'/mobile.php', 'admin.php?page=__wps__mobile_menu', '__wps__bronze__<a href="admin.php?page=__wps__mobile_menu">Options</a>');
			__wps__install_row(__('Reply_by_Email', WPS_TEXT_DOMAIN), '', '__wps__mailinglist', '-', WPS_DIR.'/mailinglist.php', 'admin.php?page='.WPS_DIR.'/symposium_mailinglist_admin.php', '__wps__bronze__<a href="admin.php?page=wp-symposium/mailinglist_admin.php">Options</a>');
			__wps__install_row(__('The_Lounge', WPS_TEXT_DOMAIN), WPS_SHORTCODE_PREFIX.'-lounge', '__wps__lounge_main', '-', WPS_DIR.'/lounge.php', 'admin.php?page='.WPS_DIR.'/lounge_admin.php', '__wps__bronze__<a href="admin.php?page=wp-symposium/lounge_admin.php">Options</a>');
			__wps__install_row(__('RSS_Feed', WPS_TEXT_DOMAIN), '', '__wps__rss_main', '-', WPS_DIR.'/rss.php', '', '__wps__bronze__');
			__wps__install_row(__('Facebook', WPS_TEXT_DOMAIN), '', '__wps__facebook', '-', WPS_DIR.'/facebook.php', 'admin.php?page='.WPS_DIR.'/facebook_admin.php', '__wps__bronze__');
			...
			//								}
						...
						echo '<table class="widefat" style="margin-top:10px; float:right;"><tr><td style="padding:0 0 0 10px">';
							...
							if( isset($_POST[ 'symposium_dailydigest' ]) && $_POST[ 'symposium_dailydigest' ] == 'Y' ) {
								...
								$to_admin = $_POST['symposium_dailydigest_admin'];
								if ($to_users == 'on' || $to_admin == 'on') {
									echo "<div style='border:1px solid #060;background-color: #9f9; border-radius:5px;padding-left:8px; margin-bottom:10px;'>Running...";
									if ($to_users == "on") {
							...
							echo '<input type="checkbox" name="symposium_dailydigest_admin" > '.__('Send Daily Digest summary to admin', WPS_TEXT_DOMAIN).'<br />';
							echo '<input type="checkbox" name="symposium_dailydigest_users" > '.__('Send Daily Digest to users (includes summary to admin)', WPS_TEXT_DOMAIN);
	...
	if (substr($install_help, 0, 7) == '__wps__') {
		...
		echo '<tr>';
			...
			echo '<td style="height:30px">';
				...
				if ($network_activated || $activated) {
...
function __wps__plugin_forum() {
	...
	global $wpdb;
		...
		?>
			...
			<?php if (get_option(WPS_OPTIONS_PREFIX.'__wps__wysiwyg_activated')) { ?>
				...
				echo __("To access WYSWIYG forum editor settings, <a href='admin.php?page=symposium_debug'>activate the Bronze member feature</a>.", WPS_TEXT_DOMAIN).'<br />';
